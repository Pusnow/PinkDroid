 ...
 * </p>
 * <p>
 * <em> Note: The Android framework is responsible for measuring, laying out and
 * drawing views. You should not call methods that perform these actions on
 * views yourself unless you are actually implementing a
 * {@link android.view.ViewGroup}. </em>
 * </p>
 *
 * <a name="Lifecycle"></a>
 ...
 * <td>Called after a view and all of its children has been inflated from
 * XML.</td>
 * </tr>
 *
 * <tr>
 ...
 *
 * <a name="IDs"></a>
 * <h3>IDs</h3> Views may have an integer id associated with them. These ids are
 * typically assigned in the layout XML files, and are used to find specific
 * views within the view tree. A common pattern is to:
 * <ul>
 ...
 * to the following computation: <code>getLeft() + getWidth()</code> (see
 * <a href="#SizePaddingMargins">Size</a> for more information about the width.)
 * </p>
 *
 ...
 *
 * <p>
 * The first pair is known as <em>measured width</em> and <em>measured
 * height</em>. These dimensions define how big a view wants to be within its
 * parent (see <a href="#Layout">Layout</a> for more details.) The measured
 * dimensions can be obtained by calling {@link #getMeasuredWidth()} and
 ...
 * any View that needs to update. After this, the drawing commands of the entire
 * tree are issued to screen, clipped to the newly damaged area.
 * </p>
 *
 * <p>
 ...
 * {@link ViewGroup#setChildrenDrawingOrderEnabled(boolean) custom child drawing
 * order} in a ViewGroup, and with {@link #setZ(float)} custom Z values} set on
 * Views.
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * <em>Note: The entire view tree is single threaded. You must always be on the
 * UI thread when calling any method on any view.</em> If you are doing work on
 * other threads and want to update the state of a view from that thread, you
 ...
 * XML or by passing a {@link ContextThemeWrapper} to the constructor from code.
 * </p>
 * <p>
 * When the {@link android.R.styleable#View_theme android:theme} attribute is
 * used in XML, the specified theme is applied on top of the inflation context's
 * theme (see {@link LayoutInflater}) and used for the view itself as well as
 * any child elements.
 * </p>
 * <p>
...
public class View implements Drawable.Callback, KeyEvent.Callback, AccessibilityEventSource {
    ...
    /**
     * Allow setForeground/setBackground to be called (and ignored) on a
     * textureview, without throwing
     */
    static boolean sTextureViewIgnoresDrawableSetters = false;

    /**
     * Prior to N, some ViewGroups would not convert LayoutParams properly even
     * though both extend MarginLayoutParams. For instance, converting
     * LinearLayout.LayoutParams to RelativeLayout.LayoutParams would lose margin
     * information. This is fixed on N but target API check is implemented for
    ...
    /**
     * Prior to N, when drag enters into child of a view that has already received
     * an ACTION_DRAG_ENTERED event, the parent doesn't get a ACTION_DRAG_EXITED
     * event. ACTION_DRAG_LOCATION and ACTION_DROP were delivered to the parent of a
     * view that returned false from its event handler for these events. Starting
     * from N, the parent will get ACTION_DRAG_EXITED event before the child gets
     * its ACTION_DRAG_ENTERED. ACTION_DRAG_LOCATION and ACTION_DROP are never
     * propagated to the parent. sCascadedDragDrop is true for pre-N apps for
     * backwards compatibility implementation.
     */
    static boolean sCascadedDragDrop;

    /**
     * This view does not want keystrokes. Use with TAKES_FOCUS_MASK when calling
     * setFlags.
     */
    ...
    /**
     * This view is visible. Use with {@link #setVisibility} and
     * <a href="#attr_android:visibility">{@code
     * android:visibility}.
     */
     ...
     * with {@link #setVisibility} and <a href="#attr_android:visibility">{@code
     * android:visibility}.
     */
    ...
    /**
     * Mask for use with setFlags indicating bits used for indicating whether this
     ...
     * called and further optimizations will be performed. It is okay to have this
     * flag set and a background. Use with DRAW_MASK when calling setFlags. {@hide}
     */
    static final int WILL_NOT_DRAW = 0x00000080;

    /**
     * Mask for use with setFlags indicating bits used for indicating whether this
     * view is will draw {@hide}
     */
     ...
     * they are optional and should be skipped if the window has requested system UI
     * flags that ignore those insets for layout.
     */
    ...
    /**
     * <p>
     * Mask for use with setFlags indicating bits used for indicating which fading
     * edges are enabled.
     * </p>
     * {@hide}
     */
    ...
    /**
     * <p>
     * Indicates this view can be clicked. When clickable, a View reacts to clicks
     * by notifying the OnClickListener.
     * <p>
     * {@hide}
     */
    ...
    private static final int[] DRAWING_CACHE_QUALITY_FLAGS = { DRAWING_CACHE_QUALITY_AUTO, DRAWING_CACHE_QUALITY_LOW,
    ...
    /**
     * <p>
     * Indicates this view can be long clicked. When long clickable, a View reacts
     * to long clicks by notifying the OnLongClickListener or showing a context
     * menu.
     * </p>
     * {@hide}
     */
    ...
    /**
     * <p>
     * Indicates that this view gets its drawable states from its direct parent and
     * ignores its original internal states.
     * </p>
     *
     * @hide
     */
    ...
    /**
     * <p>
     * Indicates this view can be context clicked. When context clickable, a View
     * reacts to a context click (e.g. a primary stylus button press or right mouse
     * click) by notifying the OnContextClickListener.
     * </p>
     * {@hide}
     */
    ...
    /**
     * View flag indicating whether this view should have haptic feedback enabled
    ...
    /**
     * <p>
     * Indicates that the view hierarchy should stop saving state when it reaches
     * this view. If state saving is initiated immediately at the view, it will be
     * allowed. {@hide}
     */
    ...
    /**
     * Use with {@link #focusSearch(int)}. Move focus to the next selectable item.
     */
     ...
     * {@link android.graphics.drawable.Drawable} to change the drawing of the view
    ...
    static {
        ...
        SELECTED_WINDOW_FOCUSED_STATE_SET = StateSet
                .get(StateSet.VIEW_STATE_WINDOW_FOCUSED | StateSet.VIEW_STATE_SELECTED);

        FOCUSED_STATE_SET = StateSet.get(StateSet.VIEW_STATE_FOCUSED);
        FOCUSED_WINDOW_FOCUSED_STATE_SET = StateSet
                .get(StateSet.VIEW_STATE_WINDOW_FOCUSED | StateSet.VIEW_STATE_FOCUSED);
        FOCUSED_SELECTED_STATE_SET = StateSet.get(StateSet.VIEW_STATE_SELECTED | StateSet.VIEW_STATE_FOCUSED);
        FOCUSED_SELECTED_WINDOW_FOCUSED_STATE_SET = StateSet
                .get(StateSet.VIEW_STATE_WINDOW_FOCUSED | StateSet.VIEW_STATE_SELECTED | StateSet.VIEW_STATE_FOCUSED);

        ENABLED_STATE_SET = StateSet.get(StateSet.VIEW_STATE_ENABLED);
        ENABLED_WINDOW_FOCUSED_STATE_SET = StateSet
                .get(StateSet.VIEW_STATE_WINDOW_FOCUSED | StateSet.VIEW_STATE_ENABLED);
        ENABLED_SELECTED_STATE_SET = StateSet.get(StateSet.VIEW_STATE_SELECTED | StateSet.VIEW_STATE_ENABLED);
        ENABLED_SELECTED_WINDOW_FOCUSED_STATE_SET = StateSet
                .get(StateSet.VIEW_STATE_WINDOW_FOCUSED | StateSet.VIEW_STATE_SELECTED | StateSet.VIEW_STATE_ENABLED);
        ENABLED_FOCUSED_STATE_SET = StateSet.get(StateSet.VIEW_STATE_FOCUSED | StateSet.VIEW_STATE_ENABLED);
        ENABLED_FOCUSED_WINDOW_FOCUSED_STATE_SET = StateSet
                .get(StateSet.VIEW_STATE_WINDOW_FOCUSED | StateSet.VIEW_STATE_FOCUSED | StateSet.VIEW_STATE_ENABLED);
        ENABLED_FOCUSED_SELECTED_STATE_SET = StateSet
                .get(StateSet.VIEW_STATE_SELECTED | StateSet.VIEW_STATE_FOCUSED | StateSet.VIEW_STATE_ENABLED);
        ENABLED_FOCUSED_SELECTED_WINDOW_FOCUSED_STATE_SET = StateSet.get(StateSet.VIEW_STATE_WINDOW_FOCUSED
                | StateSet.VIEW_STATE_SELECTED | StateSet.VIEW_STATE_FOCUSED | StateSet.VIEW_STATE_ENABLED);

        PRESSED_STATE_SET = StateSet.get(StateSet.VIEW_STATE_PRESSED);
        PRESSED_WINDOW_FOCUSED_STATE_SET = StateSet
                .get(StateSet.VIEW_STATE_WINDOW_FOCUSED | StateSet.VIEW_STATE_PRESSED);
        PRESSED_SELECTED_STATE_SET = StateSet.get(StateSet.VIEW_STATE_SELECTED | StateSet.VIEW_STATE_PRESSED);
        PRESSED_SELECTED_WINDOW_FOCUSED_STATE_SET = StateSet
                .get(StateSet.VIEW_STATE_WINDOW_FOCUSED | StateSet.VIEW_STATE_SELECTED | StateSet.VIEW_STATE_PRESSED);
        PRESSED_FOCUSED_STATE_SET = StateSet.get(StateSet.VIEW_STATE_FOCUSED | StateSet.VIEW_STATE_PRESSED);
        PRESSED_FOCUSED_WINDOW_FOCUSED_STATE_SET = StateSet
                .get(StateSet.VIEW_STATE_WINDOW_FOCUSED | StateSet.VIEW_STATE_FOCUSED | StateSet.VIEW_STATE_PRESSED);
        PRESSED_FOCUSED_SELECTED_STATE_SET = StateSet
                .get(StateSet.VIEW_STATE_SELECTED | StateSet.VIEW_STATE_FOCUSED | StateSet.VIEW_STATE_PRESSED);
        PRESSED_FOCUSED_SELECTED_WINDOW_FOCUSED_STATE_SET = StateSet.get(StateSet.VIEW_STATE_WINDOW_FOCUSED
                | StateSet.VIEW_STATE_SELECTED | StateSet.VIEW_STATE_FOCUSED | StateSet.VIEW_STATE_PRESSED);
        PRESSED_ENABLED_STATE_SET = StateSet.get(StateSet.VIEW_STATE_ENABLED | StateSet.VIEW_STATE_PRESSED);
        PRESSED_ENABLED_WINDOW_FOCUSED_STATE_SET = StateSet
                .get(StateSet.VIEW_STATE_WINDOW_FOCUSED | StateSet.VIEW_STATE_ENABLED | StateSet.VIEW_STATE_PRESSED);
        PRESSED_ENABLED_SELECTED_STATE_SET = StateSet
                .get(StateSet.VIEW_STATE_SELECTED | StateSet.VIEW_STATE_ENABLED | StateSet.VIEW_STATE_PRESSED);
        PRESSED_ENABLED_SELECTED_WINDOW_FOCUSED_STATE_SET = StateSet.get(StateSet.VIEW_STATE_WINDOW_FOCUSED
                | StateSet.VIEW_STATE_SELECTED | StateSet.VIEW_STATE_ENABLED | StateSet.VIEW_STATE_PRESSED);
        PRESSED_ENABLED_FOCUSED_STATE_SET = StateSet
                .get(StateSet.VIEW_STATE_FOCUSED | StateSet.VIEW_STATE_ENABLED | StateSet.VIEW_STATE_PRESSED);
        PRESSED_ENABLED_FOCUSED_WINDOW_FOCUSED_STATE_SET = StateSet.get(StateSet.VIEW_STATE_WINDOW_FOCUSED
                | StateSet.VIEW_STATE_FOCUSED | StateSet.VIEW_STATE_ENABLED | StateSet.VIEW_STATE_PRESSED);
        PRESSED_ENABLED_FOCUSED_SELECTED_STATE_SET = StateSet.get(StateSet.VIEW_STATE_SELECTED
                | StateSet.VIEW_STATE_FOCUSED | StateSet.VIEW_STATE_ENABLED | StateSet.VIEW_STATE_PRESSED);
        PRESSED_ENABLED_FOCUSED_SELECTED_WINDOW_FOCUSED_STATE_SET = StateSet
                .get(StateSet.VIEW_STATE_WINDOW_FOCUSED | StateSet.VIEW_STATE_SELECTED | StateSet.VIEW_STATE_FOCUSED
    ...
    /**
     * Temporary Rect currently for use in setBackground(). This will probably be
     * extended in the future to hold our own class with more than just a Rect. :)
     */
     ...
     * list invalidated, prior to the current drawing iteration. If true, the view
     * must re-draw its display list. This flag, used only when hw accelerated,
     * allows us to clear the flag while retaining this information until it's
     * needed (at getDisplayList() time and in drawChild(), when we decide to draw a
     * view's children's display lists into our own).
     *
     * {@hide}
     */
     ...
     * more) after its animation has completed. {@hide}
     */
     ...
     * the alpha must be restored. {@hide}
     */
     ...
     * recognizing a 'real' press. Prepressed is used to recognize quick taps even
     ...
     * during window attachment and it is no longer needed. Feel free to repurpose
     * it.
     *
     * @hide
     */
     ...
     * because some child view was invalidated. The flag is used to determine when
     * we need to recreate a view's display list (as opposed to just returning a
     * reference to its existing display list).
     *
     * @hide
     */
     ...
     *
     * |-------|-------|-------|-------| 1 PFLAG2_DRAG_CAN_ACCEPT 1
     * PFLAG2_DRAG_HOVERED 11 PFLAG2_LAYOUT_DIRECTION_MASK 1
     * PFLAG2_LAYOUT_DIRECTION_RESOLVED_RTL 1 PFLAG2_LAYOUT_DIRECTION_RESOLVED 11
     * PFLAG2_LAYOUT_DIRECTION_RESOLVED_MASK 1 PFLAG2_TEXT_DIRECTION_FLAGS[1] 1
     * PFLAG2_TEXT_DIRECTION_FLAGS[2] 11 PFLAG2_TEXT_DIRECTION_FLAGS[3] 1
     * PFLAG2_TEXT_DIRECTION_FLAGS[4] 1 1 PFLAG2_TEXT_DIRECTION_FLAGS[5] 11
     * PFLAG2_TEXT_DIRECTION_FLAGS[6] 111 PFLAG2_TEXT_DIRECTION_FLAGS[7] 111
     * PFLAG2_TEXT_DIRECTION_MASK 1 PFLAG2_TEXT_DIRECTION_RESOLVED 1
     * PFLAG2_TEXT_DIRECTION_RESOLVED_DEFAULT 111
     * PFLAG2_TEXT_DIRECTION_RESOLVED_MASK 1 PFLAG2_TEXT_ALIGNMENT_FLAGS[1] 1
     * PFLAG2_TEXT_ALIGNMENT_FLAGS[2] 11 PFLAG2_TEXT_ALIGNMENT_FLAGS[3] 1
     ...
     * PFLAG2_TEXT_ALIGNMENT_RESOLVED 1 PFLAG2_TEXT_ALIGNMENT_RESOLVED_DEFAULT 111
     * PFLAG2_TEXT_ALIGNMENT_RESOLVED_MASK 111
     * PFLAG2_IMPORTANT_FOR_ACCESSIBILITY_MASK 11
     * PFLAG2_ACCESSIBILITY_LIVE_REGION_MASK 1 PFLAG2_ACCESSIBILITY_FOCUSED 1
     * PFLAG2_SUBTREE_ACCESSIBILITY_STATE_CHANGED 1 PFLAG2_VIEW_QUICK_REJECTED 1
     * PFLAG2_PADDING_RESOLVED 1 PFLAG2_DRAWABLE_RESOLVED 1
     * PFLAG2_HAS_TRANSIENT_STATE |-------|-------|-------|-------|
     */

    /**
     * Indicates that this view has reported that it can accept the current drag's
     * content. Cleared when the drag operation concludes.
     * 
     * @hide
     */
    ...
    /**
     * A flag to indicate that the layout direction of this view has not been
     * defined yet.
     * 
     * @hide
     */
    ...
    /**
     * Horizontal layout direction of this view is inherited from its parent. Use
     * with {@link #setLayoutDirection}.
     */
    ...
    /**
     * Mask for use with private flags indicating bits used for horizontal layout
     * direction.
     * 
     * @hide
     */
    ...
    /**
     * Indicates whether the view horizontal layout direction has been resolved and
     * drawn to the right-to-left direction.
     * 
     * @hide
     */
    ...
    /**
     * Mask for use with private flags indicating bits used for resolved horizontal
     * layout direction.
     * 
     * @hide
     */
     ...
     * @hide
     */
    private static final int[] LAYOUT_DIRECTION_FLAGS = { LAYOUT_DIRECTION_LTR, LAYOUT_DIRECTION_RTL,
            LAYOUT_DIRECTION_INHERIT, LAYOUT_DIRECTION_LOCALE };
     ...
     * strong directional character, the paragraph direction is the view's resolved
     * layout direction.
     */
    public static final int TEXT_DIRECTION_FIRST_STRONG = 1;

    /**
     * Text direction is using "any-RTL" algorithm. The paragraph direction is RTL
     * if it contains any strong RTL character, otherwise it is LTR if it contains
     * any strong LTR characters. If there are neither, the paragraph direction is
     * the view's resolved layout direction.
     */
     ...
     * Text direction is using "first strong algorithm". The first strong
     * directional character determines the paragraph direction. If there is no
     * strong directional character, the paragraph direction is LTR.
     */
     ...
     * Text direction is using "first strong algorithm". The first strong
     * directional character determines the paragraph direction. If there is no
     * strong directional character, the paragraph direction is RTL.
     */
    ...
    /**
     * Indicates whether the view text direction has been resolved to the "first
     * strong" heuristic.
     * 
     * @hide
     */
    ...
    /** @hide */
    @IntDef({ TEXT_ALIGNMENT_INHERIT, TEXT_ALIGNMENT_GRAVITY, TEXT_ALIGNMENT_CENTER, TEXT_ALIGNMENT_TEXT_START,
    ...
    /**
     * Default text alignment. The text alignment of this View is inherited from its
    ...
    /**
     * Mask for obtainig the bits which specify how to determine whether a view is
    ...
    /**
     * Mask for obtaining the bits which specify a view's accessibility live region
     * mode.
     */
    ...
    /**
     * Flag whether the accessibility state of the subtree rooted at this view
     * changed.
     */
    static final int PFLAG2_SUBTREE_ACCESSIBILITY_STATE_CHANGED = 0x08000000;

    /**
     * Flag indicating whether a view failed the quickReject() check in draw(). This
     * condition is used to check whether later changes to the view's transform
     * should invalidate the view to force the quickReject test to run again.
     */
     ...
     * determine if padding needs to be resolved during measurement. In some special
     * cases this is required such as when an adapter-based view measures
     * prospective children without attaching them to a window.
     */
    ...
    /**
     * Indicates that the view is tracking some sort of transient state that the app
     * should not need to be aware of, but that the framework should take special
     * care to preserve.
     */
     ...
     *
     * |-------|-------|-------|-------| 1 PFLAG3_VIEW_IS_ANIMATING_TRANSFORM 1
     * PFLAG3_VIEW_IS_ANIMATING_ALPHA 1 PFLAG3_IS_LAID_OUT 1
     * PFLAG3_MEASURE_NEEDED_BEFORE_LAYOUT 1 PFLAG3_CALLED_SUPER 1
     * PFLAG3_APPLYING_INSETS 1 PFLAG3_FITTING_SYSTEM_WINDOWS 1
     * PFLAG3_NESTED_SCROLLING_ENABLED 1 PFLAG3_SCROLL_INDICATOR_TOP 1
     * PFLAG3_SCROLL_INDICATOR_BOTTOM 1 PFLAG3_SCROLL_INDICATOR_LEFT 1
     * PFLAG3_SCROLL_INDICATOR_RIGHT 1 PFLAG3_SCROLL_INDICATOR_START 1
     * PFLAG3_SCROLL_INDICATOR_END 1 PFLAG3_ASSIST_BLOCKED 1
     * PFLAG3_POINTER_ICON_NULL 1 PFLAG3_POINTER_ICON_VALUE_START 11111111
     * PFLAG3_POINTER_ICON_MASK 1 PFLAG3_OVERLAPPING_RENDERING_FORCED_VALUE 1
     * PFLAG3_HAS_OVERLAPPING_RENDERING_FORCED 1 PFLAG3_TEMPORARY_DETACH 1
     * PFLAG3_NO_REVEAL_ON_FOCUS |-------|-------|-------|-------|
     */

    /**
     * Flag indicating that view has a transform animation set on it. This is used
     * to track whether an animation is cleared between successive frames, in order
     * to tell the associated DisplayList to clear its animation matrix.
     */
    static final int PFLAG3_VIEW_IS_ANIMATING_TRANSFORM = 0x1;

    /**
     * Flag indicating that view has an alpha animation set on it. This is used to
     * track whether an animation is cleared between successive frames, in order to
     * tell the associated DisplayList to restore its alpha value.
     */
    ...
    /**
     * Flag indicating that an overridden method correctly called down to the
     * superclass implementation as required by the API spec.
     */
    ...
    /**
     * Flag indicating that we're in the process of fitting system windows using the
     * old method.
     */
    static final int PFLAG3_FITTING_SYSTEM_WINDOWS = 0x40;

    /**
     * Flag indicating that nested scrolling is enabled for this view. The view will
     * optionally cooperate with views up its parent chain to allow for integrated
     * nested scrolling along the same axis.
     */
    static final int PFLAG3_NESTED_SCROLLING_ENABLED = 0x80;

    /**
     * Flag indicating that the bottom scroll indicator should be displayed when
     * this view can scroll up.
     */
    static final int PFLAG3_SCROLL_INDICATOR_TOP = 0x0100;

    /**
     * Flag indicating that the bottom scroll indicator should be displayed when
     * this view can scroll down.
     */
    static final int PFLAG3_SCROLL_INDICATOR_BOTTOM = 0x0200;

    /**
     * Flag indicating that the left scroll indicator should be displayed when this
     * view can scroll left.
     */
    static final int PFLAG3_SCROLL_INDICATOR_LEFT = 0x0400;

    /**
     * Flag indicating that the right scroll indicator should be displayed when this
     * view can scroll right.
     */
    static final int PFLAG3_SCROLL_INDICATOR_RIGHT = 0x0800;

    /**
     * Flag indicating that the start scroll indicator should be displayed when this
     * view can scroll in the start direction.
     */
    static final int PFLAG3_SCROLL_INDICATOR_START = 0x1000;

    /**
     * Flag indicating that the end scroll indicator should be displayed when this
     * view can scroll in the end direction.
     */
    ...
    /**
     * Mask for use with setFlags indicating bits used for indicating which scroll
     * indicators are enabled.
     */
    static final int SCROLL_INDICATORS_PFLAG3_MASK = PFLAG3_SCROLL_INDICATOR_TOP | PFLAG3_SCROLL_INDICATOR_BOTTOM
            | PFLAG3_SCROLL_INDICATOR_LEFT | PFLAG3_SCROLL_INDICATOR_RIGHT | PFLAG3_SCROLL_INDICATOR_START
            | PFLAG3_SCROLL_INDICATOR_END;

    /**
     * Left-shift required to translate between public scroll indicator flags and
     * internal PFLAGS3 flags. When used as a right-shift, translates PFLAGS3 flags
     * to public flags.
     */
    ...
    /** @hide */
    @Retention(RetentionPolicy.SOURCE)
    @IntDef(flag = true, value = { SCROLL_INDICATOR_TOP, SCROLL_INDICATOR_BOTTOM, SCROLL_INDICATOR_LEFT,
            SCROLL_INDICATOR_RIGHT, SCROLL_INDICATOR_START, SCROLL_INDICATOR_END, })
    ...
    /**
     * <p>
     * Indicates that we are allowing {@link ViewStructure} to traverse into this
     * view.
     * <p>
     */
    ...
    /**
     * The mask for use with private flags indicating bits used for pointer icon
     * shapes.
     */
    ...
    /**
     * Whether this view has rendered elements that overlap (see
     * {@link #hasOverlappingRendering()},
     * {@link #forceHasOverlappingRendering(boolean)}, and
     * {@link #getHasOverlappingRendering()} ). The value in this bit is only valid
     * when PFLAG3_HAS_OVERLAPPING_RENDERING_FORCED has been set. Otherwise, the
     * value is determined by whatever {@link #hasOverlappingRendering()} returns.
     */
    private static final int PFLAG3_OVERLAPPING_RENDERING_FORCED_VALUE = 0x800000;

    /**
     * Whether {@link #forceHasOverlappingRendering(boolean)} has been called. When
     * true, value in PFLAG3_OVERLAPPING_RENDERING_FORCED_VALUE is valid.
     */
    ...
    /**
     * Special constant for {@link #setSystemUiVisibility(int)}: View has requested
     * the system UI (status bar) to be visible (the default).
     *
    ...
    /**
     * Flag for {@link #setSystemUiVisibility(int)}: View has requested the system
     * UI to enter an unobtrusive "low profile" mode.
     *
     * <p>
     ...
     * <code>SYSTEM_UI_FLAG_HIDE_NAVIGATION</code> will cause those to disappear.
     * This is useful (in conjunction with the
     * {@link android.view.WindowManager.LayoutParams#FLAG_FULLSCREEN
     * FLAG_FULLSCREEN} and
     * {@link android.view.WindowManager.LayoutParams#FLAG_LAYOUT_IN_SCREEN
     * FLAG_LAYOUT_IN_SCREEN} window flags) for displaying content using every last
    ...
    /**
     * Flag for {@link #setSystemUiVisibility(int)}: View has requested to go into
     * the normal fullscreen mode so that its content can take over the screen while
     * still allowing the user to interact with the application.
     *
     * <p>
     * This has the same visual effect as
     * {@link android.view.WindowManager.LayoutParams#FLAG_FULLSCREEN
     * WindowManager.LayoutParams.FLAG_FULLSCREEN}, meaning that non-critical screen
     * decorations (such as the status bar) will be hidden while the user is in the
     * View's window, focusing the experience on that content. Unlike the window
     * flag, if you are using ActionBar in overlay mode with
     * {@link Window#FEATURE_ACTION_BAR_OVERLAY Window.FEATURE_ACTION_BAR_OVERLAY},
     * then enabling this flag will also hide the action bar.
     *
     * <p>
     * This approach to going fullscreen is best used over the window flag when it
     * is a transient state -- that is, the application does this at certain points
     * in its user interaction where it wants to allow the user to focus on content,
     * but not as a continuous state. For situations where the application would
     * like to simply stay full screen the entire time (such as a game that wants to
     * take over the screen), the
     * {@link android.view.WindowManager.LayoutParams#FLAG_FULLSCREEN window flag}
     * is usually a better approach. The state set here will be removed by the
     * system in various situations (such as the user moving to another application)
     * like the other system UI states.
     *
     * <p>
     * When using this flag, the application should provide some easy facility for
     * the user to go out of it. A common example would be in an e-book reader,
     * where tapping on the screen brings back whatever screen and UI decorations
    ...
    /**
     * Flag for {@link #setSystemUiVisibility(int)}: When using other layout flags,
     * we would like a stable view of the content insets given to
     * {@link #fitSystemWindows(Rect)}. This means that the insets seen there will
     * always represent the worst case that the application can expect as a
     * continuous state. In the stock Android UI this is the space for the system
     * bar, nav bar, and status bar, but not more transient elements such as an
     * input method.
     *
     * The stable layout your UI sees is based on the system UI modes you can switch
     * to. That is, if you specify {@link #SYSTEM_UI_FLAG_LAYOUT_FULLSCREEN} then
     * you will get a stable layout for changes of the
     * {@link #SYSTEM_UI_FLAG_FULLSCREEN} mode; if you specify
     * {@link #SYSTEM_UI_FLAG_LAYOUT_FULLSCREEN} and
     * {@link #SYSTEM_UI_FLAG_LAYOUT_HIDE_NAVIGATION}, then you can transition to
     * {@link #SYSTEM_UI_FLAG_FULLSCREEN} and
     * {@link #SYSTEM_UI_FLAG_HIDE_NAVIGATION} with a stable layout. (Note that you
     * should avoid using {@link #SYSTEM_UI_FLAG_LAYOUT_HIDE_NAVIGATION} by itself.)
     *
     * If you have set the window flag
     * {@link WindowManager.LayoutParams#FLAG_FULLSCREEN} to hide the status bar
     * (instead of using {@link #SYSTEM_UI_FLAG_FULLSCREEN}), then a hidden status
     * bar will be considered a "stable" state for purposes here. This allows your
     * UI to continually hide the status bar, while still using the system UI flags
     * to hide the action bar while still retaining a stable layout. Note that
     ...
     * {@link Window#FEATURE_ACTION_BAR_OVERLAY Window.FEATURE_ACTION_BAR_OVERLAY},
     * this flag will also impact the insets it adds to those given to the
     * application.
     */
    public static final int SYSTEM_UI_FLAG_LAYOUT_STABLE = 0x00000100;

    /**
     * Flag for {@link #setSystemUiVisibility(int)}: View would like its window to
     * be laid out as if it has requested {@link #SYSTEM_UI_FLAG_HIDE_NAVIGATION},
     * even if it currently hasn't. This allows it to avoid artifacts when switching
     * in and out of that mode, at the expense that some of its user interface may
     * be covered by screen decorations when they are shown. You can perform layout
     * of your inner UI elements to account for the navigation system UI through the
    ...
    /**
     * Flag for {@link #setSystemUiVisibility(int)}: View would like its window to
     * be laid out as if it has requested {@link #SYSTEM_UI_FLAG_FULLSCREEN}, even
     * if it currently hasn't. This allows it to avoid artifacts when switching in
     * and out of that mode, at the expense that some of its user interface may be
     * covered by screen decorations when they are shown. You can perform layout of
     * your inner UI elements to account for non-fullscreen system UI through the
     * {@link #fitSystemWindows(Rect)} method.
     */
    public static final int SYSTEM_UI_FLAG_LAYOUT_FULLSCREEN = 0x00000400;

    /**
     * Flag for {@link #setSystemUiVisibility(int)}: View would like to remain
     * interactive when hiding the navigation bar with
     * {@link #SYSTEM_UI_FLAG_HIDE_NAVIGATION}. If this flag is not set,
     * {@link #SYSTEM_UI_FLAG_HIDE_NAVIGATION} will be force cleared by the system
     * on any user interaction.
     * <p>
     * Since this flag is a modifier for {@link #SYSTEM_UI_FLAG_HIDE_NAVIGATION}, it
     * only has an effect when used in combination with that flag.
     * </p>
     */
    ...
    /**
     * Flag for {@link #setSystemUiVisibility(int)}: View would like to remain
     * interactive when hiding the status bar with
     * {@link #SYSTEM_UI_FLAG_FULLSCREEN} and/or hiding the navigation bar with
     * {@link #SYSTEM_UI_FLAG_HIDE_NAVIGATION}. Use this flag to create an immersive
     * experience while also hiding the system bars. If this flag is not set,
     * {@link #SYSTEM_UI_FLAG_HIDE_NAVIGATION} will be force cleared by the system
     * on any user interaction, and {@link #SYSTEM_UI_FLAG_FULLSCREEN} will be
     * force-cleared by the system if the user swipes from the top of the screen.
     * <p>
     * When system bars are hidden in immersive mode, they can be revealed
     * temporarily with system gestures, such as swiping from the top of the screen.
     * These transient system bars will overlay app’s content, may have some degree
     * of transparency, and will automatically hide after a short timeout.
     * </p>
     * <p>
     * Since this flag is a modifier for {@link #SYSTEM_UI_FLAG_FULLSCREEN} and
     * {@link #SYSTEM_UI_FLAG_HIDE_NAVIGATION}, it only has an effect when used in
     * combination with one or both of those flags.
     * </p>
     */
    public static final int SYSTEM_UI_FLAG_IMMERSIVE_STICKY = 0x00001000;

    /**
     * Flag for {@link #setSystemUiVisibility(int)}: Requests the status bar to draw
     * in a mode that is compatible with light status bar backgrounds.
     *
     * <p>
     ...
     * @hide
     *
     *       NOTE: This flag may only be used in subtreeSystemUiVisibility. It is
     *       masked out of the public fields to keep the undefined bits out of the
     *       developer's way.
     *
     *       Flag to make the status bar not expandable. Unless you also set
     *       {@link #STATUS_BAR_DISABLE_NOTIFICATION_ICONS}, new notifications will
     *       continue to show.
     */
     ...
     *       developer's way.
     *
     *       Flag to hide only the recent apps button. Don't use this unless you're
     *       a special part of the system UI (i.e., setup wizard, keyguard).
     */
     ...
     *       developer's way.
     *
     *       Flag to disable the global search gesture. Don't use this unless you're
     *       a special part of the system UI (i.e., setup wizard, keyguard).
     */
     ...
     *       developer's way.
     *
     *       Flag to specify that the navigation bar is displayed in translucent
     *       mode.
     */
    ...
    /**
     * Find views that contain {@link AccessibilityNodeProvider}. Such a View is a
     * root of virtual view hierarchy and may contain the searched text. If this
     * flag is set Views with providers are automatically added and it is a
     * responsibility of the client to call the APIs of the provider to determine
     * whether the virtual tree rooted at this View contains the text, i.e. getting
     * the list of {@link AccessibilityNodeInfo}s representing the virtual views
     * with this text.
     *
     * @see #findViewsWithText(ArrayList, CharSequence, int)
     *
    ...
    @ViewDebug.ExportedProperty(flagMapping = {
            @ViewDebug.FlagToString(mask = PFLAG_FORCE_LAYOUT, equals = PFLAG_FORCE_LAYOUT, name = "FORCE_LAYOUT"),
            ...
            @ViewDebug.FlagToString(mask = PFLAG_DIRTY_MASK, equals = PFLAG_DIRTY, name = "DIRTY") }, formatToHexString = true)
    int mPrivateFlags;
    int mPrivateFlags2;
    int mPrivateFlags3;
     ...
     */
    @ViewDebug.ExportedProperty(flagMapping = {
            @ViewDebug.FlagToString(mask = SYSTEM_UI_FLAG_LOW_PROFILE, equals = SYSTEM_UI_FLAG_LOW_PROFILE, name = "SYSTEM_UI_FLAG_LOW_PROFILE", outputIf = true),
            ...
            @ViewDebug.FlagToString(mask = PUBLIC_STATUS_BAR_VISIBILITY_MASK, equals = SYSTEM_UI_FLAG_VISIBLE, name = "SYSTEM_UI_FLAG_VISIBLE", outputIf = true) }, formatToHexString = true)
     ...
     * {@link android.view.ViewGroup} to determine how this view should be laid out.
     * {@hide}
     */
    ...
    static class TransformationInfo {
         ...
         *
         * Do *not* use this variable directly; instead call getInverseMatrix(), which
         * will load the value from the View's RenderNode.
         */
         ...
         * hidden property only used by transitions, which is composited with the other
         * alpha values to calculate the final visual alpha value.
         */
     ...
     * edge of this view and the left edge of its content. {@hide}
     */
    @ViewDebug.ExportedProperty(category = "padding")
    protected int mPaddingLeft = 0;
    /**
     * The right padding in pixels, that is the distance in pixels between the right
     * edge of this view and the right edge of its content. {@hide}
     */
    @ViewDebug.ExportedProperty(category = "padding")
     ...
     * <p>
     * When non-null and valid, this is expected to contain an up-to-date copy of
     * the background drawable. It is cleared on temporary detach, and reset on
     * cleanup.
     */
    ...
    static class ListenerInfo {
        ...
        /**
         * Listener used to dispatch click events. This field should be made private, so
        ...
        /**
         * Listener used to dispatch context click events. This field should be made
         * private, so it is hidden from the SDK. {@hide}
         */
        protected OnContextClickListener mOnContextClickListener;

        /**
         * Listener used to build the context menu. This field should be made private,
         * so it is hidden from the SDK. {@hide}
         */
    ...
    /**
     * When this view has focus and the next focus is {@link #FOCUS_LEFT}, the user
     * may specify which view to go to next.
     */
    private int mNextFocusLeftId = View.NO_ID;

    /**
     * When this view has focus and the next focus is {@link #FOCUS_RIGHT}, the user
     * may specify which view to go to next.
     */
    private int mNextFocusRightId = View.NO_ID;

    /**
     * When this view has focus and the next focus is {@link #FOCUS_UP}, the user
     * may specify which view to go to next.
     */
    private int mNextFocusUpId = View.NO_ID;

    /**
     * When this view has focus and the next focus is {@link #FOCUS_DOWN}, the user
     * may specify which view to go to next.
     */
    private int mNextFocusDownId = View.NO_ID;

    /**
     * When this view has focus and the next focus is {@link #FOCUS_FORWARD}, the
    ...
    /**
     * Whether the long press's action has been invoked. The tap's action is invoked
     * on the up event while a long press is invoked as soon as the long press
     * duration is reached, so a long press could be performed before the tap is
     * checked, in which case the tap's action should not be invoked.
     */
    private boolean mHasPerformedLongPress;

    /**
     * Whether a context click button is currently pressed down. This is true when
     * the stylus is touching the screen and the primary button has been pressed, or
     * if a mouse's right button is pressed. This is false once the button is
     * released or if the stylus has been lifted.
     */
    private boolean mInContextButtonPress;

    /**
     * Whether the next up event should be ignored for the purposes of gesture
     * recognition. This is true after a stylus button press has occured, when the
     * next up event should not be recognized as a tap.
     */
    private boolean mIgnoreNextUpEvent;

    /**
     * The minimum height of the view. We'll try our best to have the height of this
     * view to at least this amount.
     */
    @ViewDebug.ExportedProperty(category = "measurement")
    private int mMinHeight;

    /**
     * The minimum width of the view. We'll try our best to have the width of this
     * view to at least this amount.
     */
    @ViewDebug.ExportedProperty(category = "measurement")
     ...
     *
     * <p>
     * If this is the only flag set, then the drag recipient will only have access
     * to text data and intents contained in the {@link ClipData} object. Access to
     * URIs contained in the {@link ClipData} is determined by other
     * DRAG_FLAG_GLOBAL_* flags
     * </p>
     */
    public static final int DRAG_FLAG_GLOBAL = 1 << 8; // 256

    /**
     * When this flag is used with {@link #DRAG_FLAG_GLOBAL}, the drag recipient
     * will be able to request read access to the content URI(s) contained in the
     * {@link ClipData} object.
     * 
    ...
    /**
     * When this flag is used with {@link #DRAG_FLAG_GLOBAL}, the drag recipient
     * will be able to request write access to the content URI(s) contained in the
     * {@link ClipData} object.
     * 
    ...
    /**
     * When this flag is used with {@link #DRAG_FLAG_GLOBAL_URI_READ} and/or
     * {@link #DRAG_FLAG_GLOBAL_URI_WRITE}, the URI permission grant can be
    ...
    /**
     * When this flag is used with {@link #DRAG_FLAG_GLOBAL_URI_READ} and/or
     * {@link #DRAG_FLAG_GLOBAL_URI_WRITE}, the URI permission grant applies to any
     ...
     * {@link #startDragAndDrop(ClipData, DragShadowBuilder, Object, int)} is called
     * with this flag set, the drag shadow will be opaque, otherwise, it will be
     * semitransparent.
     */
     ...
     * </p>
     * <p>
     * When the application is not using hardware acceleration, a software layer is
     * useful to apply a specific color filter and/or blending mode and/or
     * translucency to a view and all its children.
     * </p>
     * <p>
     * When the application is using hardware acceleration, a software layer is
     * useful to render drawing primitives not supported by the hardware accelerated
     * pipeline. It can also be used to cache a complex view tree into a texture and
     * reduce the complexity of drawing operations. For instance, when animating a
     * complex view tree with a translation, a software layer can be used to render
     * the view tree only once.
     * </p>
     * <p>
     * Software layers should be avoided when the affected view tree updates often.
     * Every update will require to re-render the software layer, which can
     ...
     * hardware) and causes the view to be rendered using Android's hardware
     * rendering pipeline, but only if hardware acceleration is turned on for the
     * view hierarchy. When hardware acceleration is turned off, hardware layers
     * behave exactly as {@link #LAYER_TYPE_SOFTWARE software layers}.
     * </p>
     *
     * <p>
     * A hardware layer is useful to apply a specific color filter and/or blending
     * mode and/or translucency to a view and all its children.
     * </p>
     * <p>
     * A hardware layer can be used to cache a complex view tree into a texture and
     * reduce the complexity of drawing operations. For instance, when animating a
     * complex view tree with a translation, a hardware layer can be used to render
     * the view tree only once.
     * </p>
     * <p>
    ...
    /**
     * RenderNode holding View properties, potentially holding a DisplayList of View
     * content.
     * <p>
     * When non-null and valid, this is expected to contain an up-to-date copy of
     * the View content. Its DisplayList content is cleared on temporary detach and
     * reset on cleanup.
     */
    final RenderNode mRenderNode;

    /**
     * Set to true when the view is sending hover accessibility events because it is
     * the innermost hovered view.
     */
    ...
    /**
     * The view's overlay layer. Developers get a reference to the overlay via
     * getOverlay() and add/remove objects to/from the overlay directly through the
     * Overlay methods.
     */
    ViewOverlay mOverlay;

    /**
     * The currently active parent view for receiving delegated nested scrolling
     * events. This is set by {@link #startNestedScroll(int)} during a touch
     * interaction and cleared by {@link #stopNestedScroll()} at the same point
     * where we clear requestDisallowInterceptTouchEvent.
     */
    ...
    /**
     * Queue of pending runnables. Used to postpone calls to post() until this view
     * is attached and has a handler.
     */
    ...
    public View(Context context) {
        ...
        if (!sCompatibilityDone && context != null) {
            ...
            // Older apps expect onMeasure() to always be called on a layout pass,
            // regardless
            ...
            // know what the expected parent size is going to be, so e.g. list items can
            // size
            ...
            // Prior to N, TextureView would silently ignore calls to
            // setBackground/setForeground.
            // On N+, we throw, but that breaks compatibility with apps that use these
            // methods.
            sTextureViewIgnoresDrawableSetters = targetSdkVersion <= M;

            // Prior to N, we would drop margins in LayoutParam conversions. The fix
            // triggers bugs
        ...
        /* PinkDroid Part Start! */
        pinkViewInvalidator.addView(this);
        /* PinkDroid Part End! */
    }

    /**
     * Constructor that is called when inflating a view from XML. This is called
     * when a view is being constructed from an XML file, supplying attributes that
     * were specified in the XML file. This version uses a default style of 0, so
    ...
    /**
     * Perform inflation from XML and apply a class-specific base style from a theme
     * attribute. This constructor of View allows subclasses to use their own base
     * style when they are inflating. For example, a Button class's constructor
     * would call this version of the super class constructor and supply
     * <code>R.attr.buttonStyle</code> for <var>defStyleAttr</var>; this allows the
     * theme's button style to modify all of the base view attributes (in particular
    ...
    /**
     * Perform inflation from XML and apply a class-specific base style from a theme
     * attribute or style resource. This constructor of View allows subclasses to
     ...
     * precedence over the following ones. In other words, if in the AttributeSet
     * you have supplied <code>&lt;Button * textColor="#ff000000"&gt;</code> , then
     * the button's text will <em>always</em> be black, regardless of what is
     ...
     *                     default values for the view, used only if defStyleAttr is
     *                     0 or can not be found in the theme. Can be 0 to not look
     *                     for defaults.
     * @see #View(Context, AttributeSet, int)
     */
    public View(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        final TypedArray a = context.obtainStyledAttributes(attrs, com.android.internal.R.styleable.View, defStyleAttr,
                defStyleRes);
        ...
        for (int i = 0; i < N; i++) {
            ...
            case R.styleable.View_backgroundTintMode:
                ...
                mBackgroundTint.mTintMode = Drawable.parseTintMode(a.getInt(R.styleable.View_backgroundTintMode, -1),
                        null);
            ...
            case R.styleable.View_scrollIndicators:
                final int scrollIndicators = (a.getInt(attr, 0) << SCROLL_INDICATORS_TO_PFLAGS3_LSHIFT)
        ...
        // Cache start/end user padding as we cannot fully resolve padding here (we dont
        // have yet
        // the resolved layout direction). Those cached values will be used later during
        // padding
        // resolution.
        ...
        // setBackground above will record that padding is currently provided by the
        // background.
        ...
        if (isRtlCompatibilityMode()) {
            ...
            // left / right padding are used if defined (meaning here nothing to do). If
            // they are not
            // defined and start / end padding are defined (e.g. in Frameworks resources),
            // then we use
            // start / end and resolve them as left / right (layout direction is not taken
            // into account).
            // Padding from the background drawable is stored at this point in
            // mUserPaddingLeftInitial
            // and mUserPaddingRightInitial) so drawable padding will be used as ultimate
            // default if
            // defined.
     ...
     * instance of these subclasses is created programmatically rather than being
     * inflated from XML. This method is automatically called when the XML is
     * inflated.
     * </p>
     *
    ...
    protected void initializeFadingEdge(TypedArray a) {
        ...
        // It relies on 'a' having been initialized using an attribute filter array that
        // is
     ...
     *
     * @param a the styled attributes set to initialize the fading edges from
     * @hide This is the real method; the public one is shimmed to be safe to call
     *       from apps.
     */
     ...
     *
     * @return The size in pixels of the vertical faded edge or 0 if vertical faded
     *         edges are not enabled for this view.
     * @attr ref android.R.styleable#View_fadingEdgeLength
     */
     ...
     *
     * @return The height in pixels of the horizontal scrollbar or 0 if there is no
    ...
    protected void initializeScrollbars(TypedArray a) {
        // It's not safe to use this method from apps. The parameter 'a' must have been
        // obtained
        // using the View filter array which is not available to the SDK. As such,
        // internal
    ...
    protected void initializeScrollbarsInternal(TypedArray a) {
        ...
        scrollabilityCache.scrollBarDefaultDelayBeforeFade = a.getInt(R.styleable.View_scrollbarDefaultDelayBeforeFade,
                ViewConfiguration.getScrollDefaultDelay());

        scrollabilityCache.scrollBarSize = a.getDimensionPixelSize(com.android.internal.R.styleable.View_scrollbarSize,
    ...
    boolean isDraggingScrollBar() {
        return mScrollCache != null && mScrollCache.mScrollBarDraggingState != ScrollabilityCache.NOT_DRAGGING;
    }
    ...
    public void setScrollIndicators(@ScrollIndicators int indicators) {
        setScrollIndicators(indicators, SCROLL_INDICATORS_PFLAG3_MASK >>> SCROLL_INDICATORS_TO_PFLAGS3_LSHIFT);
    }

    /**
     * Sets the state of the scroll indicators specified by the mask. To change all
     * scroll indicators at once, see {@link #setScrollIndicators(int)}.
     * <p>
     * When a scroll indicator is enabled, it will be displayed if the view can
     * scroll in the direction of the indicator.
     * <p>
     * Multiple indicator types may be enabled or disabled by passing the logical OR
     * of the desired types. If multiple types are specified, they will all be set
     * to the same enabled state.
     * <p>
     ...
     * <p>
     * For example, if the top and left scroll indicators are enabled and all other
     * indicators are disabled, the return value will be
     * {@code View.SCROLL_INDICATOR_TOP | View.SCROLL_INDICATOR_LEFT}.
     * <p>
     * To check whether the bottom scroll indicator is enabled, use the value of
     * {@code (getScrollIndicators() & View.SCROLL_INDICATOR_BOTTOM) != 0}.
     *
     * @return a bitmask representing the enabled scroll indicators
     */
    @ScrollIndicators
    public int getScrollIndicators() {
        return (mPrivateFlags3 & SCROLL_INDICATORS_PFLAG3_MASK) >>> SCROLL_INDICATORS_TO_PFLAGS3_LSHIFT;
    }
    ...
    /**
     * Register a callback to be invoked when the scroll X or Y positions of this
     * view change.
     * <p>
     * <b>Note:</b> Some views handle scrolling independently from View and may have
     * their own separate listeners for scroll-type events. For example,
     ...
     *
     * This listener will be called whenever this view is attached or detached from
     * a window. Remove the listener using
    ...
    /**
     * Register a callback to be invoked when this view is context clicked. If the
     * view is not context clickable, it becomes context clickable.
     *
     * @param l The callback that will run
     ...
     * @hide
     */
    public void addFrameMetricsListener(Window window, Window.OnFrameMetricsAvailableListener listener,
            Handler handler) {
        if (mAttachInfo != null) {
     ...
     * this only calls the listener, and does not do any associated clicking actions
     * like reporting an accessibility event.
     *
     * @return True there was an assigned OnClickListener that was called, false
     *         otherwise is returned.
     */
    ...
    /**
     * Calls this view's OnLongClickListener, if it is defined. Invokes the context
    ...
    /**
     * Calls this view's OnLongClickListener, if it is defined. Invokes the context
     * menu if the OnLongClickListener did not consume the event, anchoring it to an
     * (x,y) coordinate.
     *
     * @param x x coordinate of the anchoring touch event, or {@link Float#NaN} to
     *          disable anchoring
     * @param y y coordinate of the anchoring touch event, or {@link Float#NaN} to
     *          disable anchoring
     * @return {@code true} if one of the above receivers consumed the event,
     *         {@code false} otherwise
     */
    ...
    /**
     * Calls this view's OnLongClickListener, if it is defined. Invokes the context
     * menu if the OnLongClickListener did not consume the event, optionally
     ...
     * @return True if there was an assigned OnContextClickListener that consumed
    ...
    /**
     * Shows the context menu for this view anchored to the specified view-relative
     * coordinate.
     *
     * @param x the X coordinate in pixels relative to the view to which the menu
     *          should be anchored, or {@link Float#NaN} to disable anchoring
     * @param y the Y coordinate in pixels relative to the view to which the menu
     *          should be anchored, or {@link Float#NaN} to disable anchoring
     * @return {@code true} if the context menu was shown, {@code false} otherwise
     */
     ...
     *
     * @param callback Callback that will control the lifecycle of the action mode
     * @param type     One of {@link ActionMode#TYPE_PRIMARY} or
     *                 {@link ActionMode#TYPE_FLOATING}.
     * @return The new action mode if it is started, null otherwise
     *
     * @see ActionMode
     */
    ...
    /**
     * Call {@link Context#startActivityForResult(String, Intent, int, Bundle)} for
     * the View's Context, creating a unique View identifier to retrieve the result.
     *
     ...
     * 
     * @param who         The identifier for the targeted View to receive the
     *                    result.
    ...
    /**
     * Register a drag event listener callback object for this View. The parameter
     * is an implementation of {@link android.view.View.OnDragListener}. To send a
     * drag event to a View, the system calls the
     ...
     * gives it focus no matter what. It should only be called internally by
     * framework code that knows what it is doing, namely
     * {@link #requestFocus(int, Rect)}.
     *
     * @param direction             values are {@link View#FOCUS_UP},
     *                              {@link View#FOCUS_DOWN}, {@link View#FOCUS_LEFT}
     *                              or {@link View#FOCUS_RIGHT}. This is the
     *                              direction which focus moved when requestFocus()
     *                              is called. It may not always apply, in which
     *                              case use the default View.FOCUS_DOWN.
     * @param previouslyFocusedRect The rectangle of the view that had focus prior
     ...
     * this view would prefer to be brought fully into view when it gains focus. For
     * example, a text field that a user is meant to type into. Other views such as
     * scrolling containers may prefer to opt-out of this behavior.
     * </p>
     *
     * <p>
     * The default value for views is true, though subclasses may change this based
     * on their preferred behavior.
     * </p>
     *
     * @param revealOnFocus true to request reveal on focus in ancestors, false
     *                      otherwise
     *
     * @see #getRevealOnFocusHint()
     */
     ...
     * views responding to a focus change in
     * {@link ViewParent#requestChildFocus(View, View)} should make a best effort to
     * make the newly focused child fully visible to the user. When it returns
     * false, ancestor views should preferably not disrupt scroll positioning or
     * other properties affecting visibility to the user as part of the focus
     * change.
     * </p>
     *
     * @return true if this view would prefer to become fully visible when it gains
     *         focus, false if it would prefer not to disrupt scroll positioning
     *
     * @see #setRevealOnFocusHint(boolean)
     */
    ...
    /**
     * Populates <code>outRect</code> with the hotspot bounds. By default, the
     * hotspot bounds are identical to the screen bounds.
     *
     ...
     * <p>
     * The Rectangle passed into this method should be in the View's content
     * coordinate space. It should not be affected by which part of the View is
     * currently visible or its scroll position.
     *
    ...
    public boolean requestRectangleOnScreen(Rect rectangle, boolean immediate) {
        ...
        while (parent != null) {
            ...
            // move it from child's content coordinate space to parent's content coordinate
            // space
     ...
     * <p>
     * <strong>Note:</strong> When a View clears focus the framework is trying to
     * give focus to the first focusable View from the top. Hence, if this View is
     * the first from the top that can take focus, then all callbacks related to
     * clearing focus will be invoked after which the framework will give focus to
     * this view.
     * </p>
     */
    ...
    /**
     * Clears focus from the view, optionally propagating the change up through the
     * parent hierarchy and requesting that the root view place new focus.
     *
     ...
     * is what clears the old focus.
     * <p>
     * <b>NOTE:</b> The parent view's focused child must be updated manually after
     * calling this method. Otherwise, the view hierarchy may be left in an
     * inconstent state.
     */
    ...
    /**
     * Returns true if this view has focus itself, or is the ancestor of the view
     * that has focus.
     *
     ...
     * which {@link #hasFocusable()} returns true. A "reachable hasFocusable()" is a
     ...
     * previouslyFocusedRect provide insight into where the focus is coming from.
     * When overriding, be sure to call up through to the super class so that the
     * standard focus handling will occur.
     *
     * @param gainFocus             True if the View has focus; false otherwise.
     * @param direction             The direction focus has moved when
     *                              requestFocus() is called to give this view
     *                              focus. Values are {@link #FOCUS_UP},
     *                              {@link #FOCUS_DOWN}, {@link #FOCUS_LEFT},
     *                              {@link #FOCUS_RIGHT}, {@link #FOCUS_FORWARD}, or
     *                              {@link #FOCUS_BACKWARD}. It may not always
     *                              apply, in which case use the default.
     * @param previouslyFocusedRect The rectangle, in this view's coordinate system,
     *                              of the previously focused view. If applicable,
     *                              this will be passed in as finer grained
     *                              information about where the focus is coming from
     *                              (in addition to direction). Will be
     ...
     * {@link #onInitializeAccessibilityEvent(AccessibilityEvent)} first to populate
     * information about the event source (this View), then calls
     * {@link #dispatchPopulateAccessibilityEvent(AccessibilityEvent)} to populate
     * the text content of the event source including its descendants, and last
     * calls
     * {@link ViewParent#requestSendAccessibilityEvent(View, AccessibilityEvent)} on
     * its parent to request sending of the event to interested parties.
     * <p>
     ...
     * </p>
     *
     * @param eventType The type of the event to send, as defined by several types
     ...
     * sort of a context change for which none of the events representing UI
     * transitions is a good fit. For example, announcing a new page in a book. If
     * accessibility is not enabled this method does nothing.
     *
    ...
    /**
     * This method behaves exactly as {@link #sendAccessibilityEvent(int)} but takes
     * as an argument an empty {@link AccessibilityEvent} and does not perform a
    ...
    public void sendAccessibilityEventUncheckedInternal(AccessibilityEvent event) {
        ...
        // In the beginning we called #isShown(), so we know that getParent() is not
        // null.
     ...
     * event text is populated in a separate dispatch path since we add to the event
     * not only the text of the source but also the text of all its descendants. A
     * typical implementation will call
     ...
     * child. Override this method if custom population of the event text content is
     * required.
     * <p>
     * If an {@link AccessibilityDelegate} has been specified via calling
     * {@link #setAccessibilityDelegate(AccessibilityDelegate)} its
     ...
     * text content. While this method is free to modify event attributes other than
    ...
    /**
     * Initializes an {@link AccessibilityEvent} with information about this View
     * which is the event source. In other words, the source of an accessibility
     * event is the view whose state change triggered firing the event.
     * <p>
    ...
    public void onInitializeAccessibilityEventInternal(AccessibilityEvent event) {
        ...
        case AccessibilityEvent.TYPE_VIEW_FOCUSED: {
            ArrayList<View> focusablesTempList = (mAttachInfo != null) ? mAttachInfo.mTempArrayList
                    : new ArrayList<View>();
     ...
     * calling {@link AccessibilityNodeInfo#recycle()} to minimize object creation.
     * </p>
     *
    ...
    public void getBoundsOnScreen(Rect outRect, boolean clipToParent) {
        ...
        outRect.set(Math.round(position.left), Math.round(position.top), Math.round(position.right),
     ...
     * 
     * @param structure Fill in with structured view data. The default
     *                  implementation fills in all data that can be inferred from
     *                  the view itself.
     */
     ...
     * to generate additional virtual structure under this view. The defaullt
     * implementation uses {@link #getAccessibilityNodeProvider()} to try to
     * generate this from the view's virtual accessibility nodes, if any. You can
     * override this for a more optimal implementation providing this data.
     */
    ...
    private void populateVirtualStructure(ViewStructure structure, AccessibilityNodeProvider provider,
    ...
    public void onInitializeAccessibilityNodeInfoInternal(AccessibilityNodeInfo info) {
        ...
        if (mID != View.NO_ID) {
            ...
            if ((mAttachInfo.mAccessibilityFetchFlags & AccessibilityNodeInfo.FLAG_REPORT_VIEW_IDS) != 0
    ...
    /**
     * Determine the order in which this view will be drawn relative to its siblings
     * for a11y
     *
    ...
    private void populateAccessibilityNodeInfoDrawingOrderInParent(AccessibilityNodeInfo info) {
        /*
         * If the view's bounds haven't been set yet, layout has not completed. In that
         * situation, drawing order may not be well-defined, and some Views with custom
         * drawing order may not be initialized sufficiently to respond properly
                        ...
                        if (childDrawIndex != 0) {
                            for (int i = 0; i < numChildrenToIterate; i++) {
                                final int otherDrawIndex = (customOrder
                                        ? parentGroup.getChildDrawingOrder(childCount, i)
                                        : i);
    ...
    /**
     * Computes whether the given portion of this view is visible to the user. Such
     * a view is attached, visible, all its predecessors are visible, has an alpha
     * greater than zero, and the specified portion is not clipped entirely by its
     * predecessors.
     *
     * @param boundInView the portion of the view to test; coordinates should be
     *                    relative; may be <code>null</code>, and the entire view
     *                    will be tested in this case. When <code>true</code> is
     *                    returned by the function, the actual visible region will
     *                    be stored in this parameter; that is, if boundInView is
     *                    fully contained within the view, no modification will be
     *                    made, otherwise regions outside of the visible area of the
     ...
     * For more details see {@link AccessibilityDelegate}.
     *
     ...
     * opposed to inheritance). For more details, see {@link AccessibilityDelegate}.
     * <p>
     * <strong>Note:</strong> On platform versions prior to
     * {@link android.os.Build.VERSION_CODES#M API 23}, delegate methods on views in
     * the {@code android.widget.*} package are called <i>before</i> host methods.
     * This prevents certain properties such as class name from being modified by
     * overriding
     * {@link AccessibilityDelegate#onInitializeAccessibilityNodeInfo(View, AccessibilityNodeInfo)},
     * as any changes will be overwritten by the host class.
     * <p>
     * Starting in {@link android.os.Build.VERSION_CODES#M API 23}, delegate methods
     * are called <i>after</i> host methods, which all properties to be modified
     * without being overwritten by the host class.
     *
     ...
     * purposes. If this {@link View} is not attached to any window, {@value #NO_ID}
     * is returned.
     *
     ...
     * <p>
     * <strong>Note:</strong> Do not override this method, as it will have no effect
     * on the content description presented to accessibility services. You must call
     * {@link #setContentDescription(CharSequence)} to modify the content
     * description.
     *
     ...
     * <p>
     * A content description briefly describes the view and is primarily used for
     * accessibility support to determine how a view should be presented to the
     * user. In the case of a view with no textual representation, such as
     * {@link android.widget.ImageButton}, a useful content description explains
     * what the view does. For example, an image button with a phone icon that is
     * used to place a call may use "Call" as its content description. An image of a
    ...
    /**
     * Sets the id of a view before which this one is visited in accessibility
     * traversal. A screen-reader must visit the content of this view before the
     * content of the one it precedes. For example, if view B is set to be before
     * view A, then a screen-reader will traverse the entire content of B before
     * traversing the entire content of A, regardles of what traversal strategy it
     * is using.
     * <p>
     * Views that do not have specified before/after relationships are traversed in
     * order determined by the screen-reader.
     * </p>
     * <p>
     * Setting that this view is before a view that is not important for
     * accessibility or if this view is not important for accessibility will have no
     * effect as the screen-reader is not aware of unimportant views.
     * </p>
     *
     * @param beforeId The id of a view this one precedes in accessibility
     *                 traversal.
     *
    ...
    /**
     * Gets the id of a view before which this one is visited in accessibility
     * traversal.
     *
    ...
    /**
     * Sets the id of a view after which this one is visited in accessibility
     * traversal. A screen-reader must visit the content of the other view before
     * the content of this one. For example, if view B is set to be after view A,
     * then a screen-reader will traverse the entire content of A before traversing
     * the entire content of B, regardles of what traversal strategy it is using.
     * <p>
     * Views that do not have specified before/after relationships are traversed in
     * order determined by the screen-reader.
     * </p>
     * <p>
     * Setting that this view is after a view that is not important for
     * accessibility or if this view is not important for accessibility will have no
     * effect as the screen-reader is not aware of unimportant views.
     * </p>
     *
     * @param afterId The id of a view this one succedees in accessibility
     *                traversal.
     *
    ...
    /**
     * Gets the id of a view after which this one is visited in accessibility
     * traversal.
     *
     ...
     * losing focus within its window. This method can be used to clear any state
     * tied to the focus. For instance, if a button is held pressed with the
     * trackball and the window loses focus, this method can be used to cancel the
     * press.
     *
     ...
     *
     * @return The view that currently has focus, or null if no focused view can be
     *         found.
     */
     ...
     * window.
     *
     * @return whether this view is one of the set of scrollable containers in its
     *         window
     *
     * @attr ref android.R.styleable#View_isScrollContainer
     */
     ...
     * pan when a soft input area is open -- scrollable containers allow the window
     * to use resize mode since the container will appropriately shrink.
     *
     * @attr ref android.R.styleable#View_isScrollContainer
     */
     ...
     * 
     * @return The next focus ID, or {@link #NO_ID} if the framework should decide
     *         automatically.
     *
     * @attr ref android.R.styleable#View_nextFocusLeft
     */
     ...
     * 
     * @param nextFocusLeftId The next focus ID, or {@link #NO_ID} if the framework
     ...
     * 
     * @param nextFocusRightId The next focus ID, or {@link #NO_ID} if the framework
     *                         should decide automatically.
     *
     * @attr ref android.R.styleable#View_nextFocusRight
     */
     ...
     * 
     * @param nextFocusUpId The next focus ID, or {@link #NO_ID} if the framework
     *                      should decide automatically.
     *
     * @attr ref android.R.styleable#View_nextFocusUp
     */
     ...
     * 
     * @param nextFocusDownId The next focus ID, or {@link #NO_ID} if the framework
     *                        should decide automatically.
     *
     * @attr ref android.R.styleable#View_nextFocusDown
     */
     ...
     * 
     * @param nextFocusForwardId The next focus ID, or {@link #NO_ID} if the
     *                           framework should decide automatically.
     *
     * @attr ref android.R.styleable#View_nextFocusForward
     */
     ...
     * changed, to allow it to adjust its content to fit within those windows. The
     * content insets tell you the space that the status bar, input method, and
     * other system windows infringe on the application's window.
     *
     * <p>
     ...
     * the window. If you use {@link #SYSTEM_UI_FLAG_LAYOUT_FULLSCREEN} or
     * {@link #SYSTEM_UI_FLAG_LAYOUT_HIDE_NAVIGATION} this will not be the case, and
     * your content can be placed under those system elements. You can then use this
     * method within your view hierarchy if you have parts of your UI which you
     * would like to ensure are not being covered.
     *
     * <p>
     * The default implementation of this method simply applies the content insets
     * to the view's padding, consuming that content (modifying the insets to be 0),
     * and returning true. This behavior is off by default, but can be enabled
     * through {@link #setFitsSystemWindows(boolean)}.
     *
     * <p>
     * This function's traversal down the hierarchy is depth-first. The same content
     * insets object is propagated down the hierarchy, so any changes made to it
     * will be seen by all following views (including potentially ones above in the
     ...
     * insets to its content on all edges. If you need a more complicated layout
     * (such as two different views fitting system windows, one on the top of the
     * window, and one on the bottom), you can override the method and handle the
     * insets however you would like. Note that the insets provided by the framework
     * are always relative to the far edges of the window, not accounting for the
     * location of the called view within that window. (In fact when this method is
     * called you do not yet know where the layout will place the view, as it is
     * done before layout happens.)
     *
     * <p>
     * Note: unlike many View methods, there is no dispatch phase to this call. If
     * you are overriding it in a ViewGroup and want to allow the call to continue
     * to your children, you must be sure to call the super implementation.
     *
     * <p>
     ...
     *         continue propagating further down the hierarchy, {@code false}
     *         otherwise.
     * @see #getFitsSystemWindows()
     * @see #setFitsSystemWindows(boolean)
     * @see #setSystemUiVisibility(int)
     *
     * @deprecated As of API 20 use {@link #dispatchApplyWindowInsets(WindowInsets)}
     *             to apply insets to views. Views should override
     *             {@link #onApplyWindowInsets(WindowInsets)} or use
    ...
    /**
     * Called when the view should apply {@link WindowInsets} according to its
     * internal policy.
     *
     * <p>
     * This method should be overridden by views that wish to apply a policy
     * different from or in addition to the default behavior. Clients that wish to
     * force a view subtree to apply insets should call
     * {@link #dispatchApplyWindowInsets(WindowInsets)}.
     * </p>
     *
     * <p>
     * Clients may supply an {@link OnApplyWindowInsetsListener} to a view. If one
     * is set it will be called during dispatch instead of this method. The listener
     * may optionally call this method from its own implementation if it wishes to
     * apply the view's default insets policy in addition to its own.
     * </p>
     *
     * <p>
     * Implementations of this method should either return the insets parameter
     * unchanged or a new {@link WindowInsets} cloned from the supplied insets with
     * any insets consumed that this view applied itself. This allows new inset
     * types added in future platform versions to pass through existing
     * implementations unchanged without being erroneously consumed.
     * </p>
     *
     * <p>
     * By default if a view's {@link #setFitsSystemWindows(boolean)
     * fitsSystemWindows} property is set then the view will consume the system
     * window insets and apply them as padding for the view.
     * </p>
     *
    ...
    /**
     * Set an {@link OnApplyWindowInsetsListener} to take over the policy for
     * applying window insets to this view. The listener's
     * {@link OnApplyWindowInsetsListener#onApplyWindowInsets(View, WindowInsets)
     * onApplyWindowInsets} method will be called instead of the view's
    ...
    /**
     * Request to apply the given window insets to this view or another view in its
     * subtree.
     *
     * <p>
     * This method should be called by clients wishing to apply insets corresponding
     * to areas obscured by window decorations or overlays. This can include the
     * status and navigation bars, action bars, input methods and more. New inset
     * categories may be added in the future. The method returns the insets provided
     * minus any that were applied by this view or its children.
     * </p>
     *
     * <p>
     ...
     * {@link #setOnApplyWindowInsetsListener(View.OnApplyWindowInsetsListener)
     * setOnApplyWindowInsetsListener} method.
     * </p>
     *
     * <p>
     * This method replaces the older {@link #fitSystemWindows(Rect)
     * fitSystemWindows} method.
     * </p>
     *
     * @param insets Insets to apply
     ...
     *
     * <p>
     * Computes the coordinates of this view in its surface. The argument must be an
     * array of two integers. After the method returns, the array contains the x and
     * y location in that order.
     * </p>
     * 
     * @hide
    ...
    /**
     * Provide original WindowInsets that are dispatched to the view hierarchy. The
     * insets are only available if the view is attached.
     *
     * @return WindowInsets from the top of the view hierarchy or null if View is
     *         detached
     */
    ...
    /**
     * Compute insets that should be consumed by this view and the ones that should
     * propagate to those under it.
     *
     * @param in             Insets currently being processed by this View, likely
     *                       received as a parameter to
     *                       {@link #onApplyWindowInsets(WindowInsets)}.
     * @param outLocalInsets A Rect that will receive the insets that should be
     ...
     * {@link #fitSystemWindows(Rect)}, then there is no need to set this flag to
     * true -- your implementation will be overriding the default implementation
     ...
     * returns {@code true}, the default implementation of
     * {@link #fitSystemWindows(Rect)} will be executed.
     *
    ...
    /**
     * Ask that a new dispatch of {@link #onApplyWindowInsets(WindowInsets)} be
     * performed.
     */
    ...
    /**
     * Returns the outsets, which areas of the device that aren't a surface, but we
     * would like to treat them as such.
     * 
     * @hide
     */
    ...
    public void setEnabled(boolean enabled) {
        ...
        /*
         * The View most likely has to change its appearance, so refresh the drawable
         * state.
         */
        refreshDrawableState();
     ...
     *
     * @param focusableInTouchMode If true, this view can receive the focus while in
     *                             touch mode.
     *
    ...
    /**
     * @return whether this view should have sound effects enabled for events such
    ...
    /**
     * @return whether this view should have haptic feedback enabled for events long
     *         presses.
     *
     ...
     *
     * @return One of {@link #LAYOUT_DIRECTION_LTR}, {@link #LAYOUT_DIRECTION_RTL},
     ...
     *                        LAYOUT_DIRECTION_INHERIT. The resolution proceeds up
     *                        the parent chain of the view to get the value. If
     *                        there is no parent, then it will return the default
     *                        {@link #LAYOUT_DIRECTION_LTR}.
     *
     * @attr ref android.R.styleable#View_layoutDirection
     */
     ...
     *         returns {@link #LAYOUT_DIRECTION_LTR} if the layout direction is not
     *         RTL.
     *
     *         For compatibility, this will return {@link #LAYOUT_DIRECTION_LTR} if
     *         API version is lower than
     ...
     * counted, so every call to setHasTransientState(true) should be paired with a
     * later call to setHasTransientState(false).
     *
     * <p>
     * A view with transient state cannot be trivially rebound from an external data
     * source, such as an adapter binding item views in a list. This may be because
     ...
     * further optimizations. By default, this flag is not set on View, but could be
     * set on some View subclasses such as ViewGroup.
     *
     ...
     * bitmap. Some views, like an ImageView, must be able to bypass this mechanism
     * if they already draw a single bitmap, to avoid unnecessary usage of the
     * memory.
     *
     * @param willNotCacheDrawing true if this view does not cache its drawing,
     *                            false otherwise
     */
    ...
    /**
     * Enables or disables context clicking for this view. This event can launch the
     * listener.
     *
     * @param contextClickable true to make the view react to a context click, false
     *                         otherwise
     ...
     * {@link #setPressed(boolean)} is explicitly called, only clickable views can
     ...
     *       {@link ViewStructure}. If true, it will not provide any data for itself
     *       or its children. If false, the normal data collection will be allowed.
     *
    ...
    /**
     * @hide Controls whether assist data collection from this view and its children
     *       is enabled (that is, whether {@link #onProvideStructure} and
     *       {@link #onProvideVirtualStructure} will be called). The default value
     *       is false, allowing normal assist collection. Setting this to false will
     *       disable assist collection.
     *
     * @param enabled Set to true to <em>disable</em> assist data collection, or
     *                false (the default) to allow it.
     *
     * @see #isAssistBlocked()
     ...
     * its {@link #onSaveInstanceState} method will be called). Note that even if
     * freezing is enabled, the view still must have an id assigned to it (via
     * {@link #setId(int)}) for its state to be saved. This flag can only disable
     * the saving of this view; any child views may still have their state saved.
     *
     * @param enabled Set to false to <em>disable</em> state saving, or true (the
     *                default) to allow it.
     *
     * @see #isSaveEnabled()
     * @see #setId(int)
     ...
     * obscured by another visible window. Refer to the {@link View} security
    ...
    /**
     * Indicates whether the entire hierarchy under this view will save its state
     * when a state saving traversal occurs from its parent. The default is true; if
     * false, these views will not be saved unless
     * {@link #saveHierarchyState(SparseArray)} is called directly on this view.
     *
     * @return Returns true if the view state saving from parent is enabled, else
     *         false.
     *
     ...
     * For example, a button would like focus when the user is navigating via a
     * D-pad so that the user can click on it, but once the user starts touching the
     * screen, the button shouldn't take focus
     * 
    ...
    /**
     * Find the nearest view in the specified direction that can take focus. This
     * does not actually give focus to that view.
     *
     * @param direction One of FOCUS_UP, FOCUS_DOWN, FOCUS_LEFT, and FOCUS_RIGHT
     *
     * @return The nearest focusable in the specified direction, or null if none can
     *         be found.
     */
     ...
     * the key internally, nor could the view system find a new view in the
     * requested direction to give focus to.
     *
    ...
    /**
     * If a user manually specified the next view id for a particular direction, use
     * the root to look up the view.
     * 
     * @param root      The root view of the hierarchy containing this view.
     * @param direction One of FOCUS_UP, FOCUS_DOWN, FOCUS_LEFT, FOCUS_RIGHT,
     ...
     * including this view if it is focusable itself) to views. This method adds all
     * focusable views regardless if we are in touch mode or only views focusable in
     * touch mode if we are in touch mode or only views that can take accessibility
     * focus if accessibility is enabled depending on the focusable mode parameter.
     *
     * @param views         Focusable views found so far or null if all we are
     *                      interested is the number of focusables.
     * @param direction     The direction of the focus.
     ...
     * The search is performed by either the text that the View renders or the
     * content description that describes the view for accessibility purposes and
     * the view does not render or both. Clients can specify how the search is to be
     * performed via passing the {@link #FIND_VIEWS_WITH_TEXT} and
    ...
    public void findViewsWithText(ArrayList<View> outViews, CharSequence searched, @FindViewFlags int flags) {
        ...
        } else if ((flags & FIND_VIEWS_WITH_CONTENT_DESCRIPTION) != 0 && (searched != null && searched.length() > 0)
    ...
    public void addTouchables(ArrayList<View> views) {
        ...
        if (((viewFlags & CLICKABLE) == CLICKABLE || (viewFlags & LONG_CLICKABLE) == LONG_CLICKABLE
                || (viewFlags & CONTEXT_CLICKABLE) == CONTEXT_CLICKABLE) && (viewFlags & ENABLED_MASK) == ENABLED) {
            views.add(this);
        }
    }
     ...
     * invoked in {@link #clearAccessibilityFocus()}. This method is used separately
     * from that one for clearing accessibility focus when giving this focus to
     * another view.
     *
     * @param action The action, if any, that led to focus being cleared. Set to
     *               AccessibilityNodeInfo#ACTION_ACCESSIBILITY_FOCUS to specify
     *               that focus is moving within the window.
     */
        ...
        if ((mPrivateFlags2 & PFLAG2_ACCESSIBILITY_FOCUSED) != 0) {
            ...
            if (AccessibilityManager.getInstance(mContext).isEnabled()) {
                AccessibilityEvent event = AccessibilityEvent
                        .obtain(AccessibilityEvent.TYPE_VIEW_ACCESSIBILITY_FOCUS_CLEARED);
     ...
     * focusable in touch mode ({@link #isFocusableInTouchMode}) while the device is
     * in touch mode.
     *
     * See also {@link #focusSearch(int)}, which is what you call to say that you
     * have focus, and you want your parent to look for the next one.
    ...
    /**
     * Call this to try to give focus to a specific view or to one of its
     * descendants and give it hints about the direction and a specific rectangle
     * that the focus is coming from. The rectangle can help give larger views a
     * finer grained hint about where focus is coming from, and therefore, where to
     * show selection, or forward focus change internally.
     *
     * A view will not actually take focus if it is not focusable
     * ({@link #isFocusable} returns false), or if it is focusable and it is not
     * focusable in touch mode ({@link #isFocusableInTouchMode}) while the device is
    ...
    /**
     * Call this to try to give focus to a specific view or to one of its
     * descendants. This is a special variant of {@link #requestFocus() } that will
     * allow views that are not focusable in touch mode to request focus when they
     * are touched.
     *
     * @return Whether this view or one of its descendants actually took focus.
     *
     ...
     * accessibility which is if it fires accessibility events and if it is reported
     * to accessibility services that query the screen.
     *
     ...
     * services whether they should automatically notify the user about changes to
     * the view's content description or text, or to the content descriptions or
     * text of the view's children (where applicable).
     * <p>
     ...
     * {@link #ACCESSIBILITY_LIVE_REGION_NONE}. This is the default live region mode
     * for most views.
     * <p>
    ...
    /**
     * Sets how to determine whether this view is important for accessibility which
     * is if it fires accessibility events and if it is reported to accessibility
     * services that query the screen.
     *
     * @param mode How to determine whether this view is important for
     *             accessibility.
     *
     * @attr ref android.R.styleable#View_importantForAccessibility
     *
    ...
    /**
     * Returns the view within this view's hierarchy that is hosting accessibility
     * focus.
     *
    ...
    /**
     * Computes whether this view should be exposed for accessibility. In general,
     * views that are interactive or provide information are exposed while views
     * that serve only as containers are hidden.
     * <p>
     * If an ancestor of this view has importance
     * {@link #IMPORTANT_FOR_ACCESSIBILITY_NO_HIDE_DESCENDANTS}, this method returns
     * <code>false</code>.
     * <p>
     ...
     * <ul>
     * <li>Is actionable, e.g. {@link #isClickable()}, {@link #isLongClickable()},
     * or {@link #isFocusable()}
    ...
    public boolean isImportantForAccessibility() {
        final int mode = (mPrivateFlags2
                & PFLAG2_IMPORTANT_FOR_ACCESSIBILITY_MASK) >> PFLAG2_IMPORTANT_FOR_ACCESSIBILITY_SHIFT;
     ...
     *
     * @param outChildren The output list that will receive children for
     *                    accessibility.
     */
    ...
    /**
     * Returns whether the View has registered callbacks which makes it important
     * for accessibility.
     *
     * @return True if the view is actionable for accessibility.
     */
    private boolean hasListenersForAccessibility() {
        ...
        return mTouchDelegate != null || info.mOnKeyListener != null || info.mOnTouchListener != null
                || info.mOnGenericMotionListener != null || info.mOnHoverListener != null
                || info.mOnDragListener != null;
    }

    /**
     * Notifies that the accessibility state of this view changed. The change is
     * local to this view and does not represent structural changes such as children
     * and parent. For example, the view became focusable. The notification is at at
     * most once every
     * {@link ViewConfiguration#getSendRecurringAccessibilityEventsInterval()} to
     * avoid unnecessary load to the system. Also once a view has a pending
    ...
    /**
     * Notifies that the accessibility state of this view changed. The change is
     * *not* local to this view and does represent structural changes such as
     * children and parent. For example, the view size changed. The notification is
     * at at most once every
     * {@link ViewConfiguration#getSendRecurringAccessibilityEventsInterval()} to
     * avoid unnecessary load to the system. Also once a view has a pending
     * notification this method is a NOP until the notification has been sent.
     *
    ...
    /**
     * Change the visibility of the View without triggering any other changes. This
     * is important for transitions, where visibility changes should not adjust
     * focus or trigger a new layout. This is only used when the visibility has
     * already been changed and we need a transient value during an animation. When
     * the animation completes, the original visibility value is always restored.
     *
     * @param visibility One of {@link #VISIBLE}, {@link #INVISIBLE}, or
     *                   {@link #GONE}.
     * @hide
    ...
    /**
     * Reset the flag indicating the accessibility state of the subtree rooted at
     * this view changed.
     */
    ...
    /**
     * Report an accessibility action to this view's parents for delegated
     * processing.
     *
     * <p>
     * Implementations of {@link #performAccessibilityAction(int, Bundle)} may
     * internally call this method to delegate an accessibility action to a
     * supporting parent. If the parent returns true from its
     ...
     * {@link #isNestedScrollingEnabled()} returns true and the action is a
     * scrolling action a custom view implementation may invoke this method to allow
     * a parent to consume the scroll first. If this method returns true the custom
     * view should skip its own scrolling behavior.
     * </p>
     *
     ...
     * {@link AccessibilityNodeInfo#ACTION_SCROLL_FORWARD} to nested scrolling
     * parents if {@link #isNestedScrollingEnabled() nested scrolling is enabled} on
     * this view.
     * </p>
     *
    ...
    public boolean performAccessibilityActionInternal(int action, Bundle arguments) {
        if (isNestedScrollingEnabled() && (action == AccessibilityNodeInfo.ACTION_SCROLL_BACKWARD
                || action == AccessibilityNodeInfo.ACTION_SCROLL_FORWARD || action == R.id.accessibilityActionScrollUp
    ...
    public TextSegmentIterator getIteratorForGranularity(int granularity) {
        ...
        case AccessibilityNodeInfo.MOVEMENT_GRANULARITY_WORD: {
            CharSequence text = getIterableTextForAccessibility();
            if (text != null && text.length() > 0) {
                WordTextSegmentIterator iterator = WordTextSegmentIterator
                        .getInstance(mContext.getResources().getConfiguration().locale);
                iterator.initialize(text.toString());
                return iterator;
            }
    ...
    /**
     * Tells whether the {@link View} is in the state between
     * {@link #onStartTemporaryDetach()} and {@link #onFinishTemporaryDetach()}.
     *
     * <p>
     * This method always returns {@code true} when called directly or indirectly
     * from {@link #onStartTemporaryDetach()}. The return value when called directly
     * or indirectly from {@link #onFinishTemporaryDetach()}, however, depends on
     * the OS version.
     * <ul>
     * <li>{@code true} on {@link android.os.Build.VERSION_CODES#N API 24}</li>
     * <li>{@code false} on {@link android.os.Build.VERSION_CODES#N_MR1 API 25}} and
     * later</li>
     * </ul>
     * </p>
     *
     * @return {@code true} when the View is in the state between
     *         {@link #onStartTemporaryDetach()} and
    ...
    /**
     * Dispatch {@link #onStartTemporaryDetach()} to this View and its direct
     ...
     * for this view's window. Returns null if the view is not currently attached to
     * the window. Normally you will not need to use this directly, but just use the
     * standard high-level event callbacks like {@link #onKeyDown(int, KeyEvent)}.
     */
    ...
    /**
     * Dispatch a key event before it is processed by any input method associated
     * with the view hierarchy. This can be used to intercept key events in special
     * situations before the IME consumes them; a typical example would be handling
     * the BACK key to update the application's UI instead of allowing the IME to
     ...
     * @return True if the event should be dispatched, false if the event should be
     *         dropped.
     *
     * @see #getFilterTouchesWhenObscured
     */
     ...
     * {@link InputDevice#SOURCE_CLASS_POINTER} are delivered to the view under the
     * pointer. All other generic motion events are delivered to the focused view.
     * Hover events are handled specially and are delivered to
     ...
     * {@link MotionEvent#ACTION_HOVER_ENTER}. If this view is hovered and it does
     * not have a hovered child, then it must be the innermost hovered view.
     * 
     * @hide
     */
     ...
     * <p>
     * Dispatches touch related pointer events to {@link #onTouchEvent(MotionEvent)}
     * and all other events to {@link #onGenericMotionEvent(MotionEvent)}. This
     * separation of concerns reinforces the invariant that
     * {@link #onTouchEvent(MotionEvent)} is really about touches and should not be
     ...
     *
     * @param hasFocus True if the window containing this view now has focus, false
     *                 otherwise.
     */
     ...
     * this is separate from view focus: to receive key events, both your view and
     * its window must have focus. If a window is displayed on top of yours that
     * takes input focus, then your own window will lose focus but the view focus
     ...
     * 
     * @param changedView The view whose visibility changed. Could be 'this' or an
     *                    ancestor view.
     ...
     * changed.
     *
     * @param changedView The view whose visibility changed. May be {@code this} or
     *                    an ancestor view.
    ...
    /**
     * Dispatch a hint about whether this view is displayed. For instance, when a
     * View moves out of the screen, it might receives a display hint indicating the
     * view is not displayed. Applications should not <em>rely</em> on this hint as
     * there is no guarantee that they will receive one.
     *
    ...
    /**
     * Internal dispatching method for {@link #onVisibilityAggregated}. Overridden
     * by ViewGroup. Intended to only be called when {@link #isAttachedToWindow()},
     * {@link #getWindowVisibility()} is {@link #VISIBLE} and this view's parent
     * {@link #isShown()}.
     *
     * @param isVisible true if this view's visibility to the user is uninterrupted
     *                  by its ancestors or by window visibility
     * @return true if this view is visible to the user, not counting clipping or
     *         overlapping
     */
    ...
    /**
     * Called when the user-visibility of this View is potentially affected by a
     * change to this view itself, an ancestor view or the window this view is
     * attached to.
     *
     * @param isVisible true if this view and all of its ancestors are
     *                  {@link #VISIBLE} and this view's window is also visible
     */
    @CallSuper
     ...
     * {@link #GONE}, {@link #INVISIBLE}, or {@link #VISIBLE}).
     *
     ...
     * decorations above the window, for both cases where the window itself is being
     * position inside of them or the window is being placed under then and covered
     * insets are used for the window to position its content inside. In effect,
     * this tells you the available area where content can be placed and remain
     * visible to users.
     *
     * <p>
     ...
     * like drawing.
     *
     * @param outRect Filled in with the visible display frame. If the view is not
    ...
    /**
     * Like {@link #getWindowVisibleDisplayFrame}, but returns the "full" display
     * frame this window is currently in without any insets.
     *
     * @hide
     */
     ...
     * that can changed based on orientation and other configuration
     * characteristics. You only need to use this if you are not relying on the
     ...
     * various things like whether focus is always visible to the user.
     *
     ...
     * KeyEvent.Callback.onKeyLongPress()}: always returns false (doesn't handle the
     * event).
     * <p>
     * Key presses in software keyboards will generally NOT trigger this listener,
     * although some may elect to do so in some situations. Do not rely on this to
     ...
     * {@link KeyEvent#KEYCODE_DPAD_CENTER}, {@link KeyEvent#KEYCODE_ENTER} or
     * {@link KeyEvent#KEYCODE_SPACE} is released.
     * <p>
     * Key presses in software keyboards will generally NOT trigger this listener,
     * although some may elect to do so in some situations. Do not rely on this to
     * catch software key presses.
     ...
     * KeyEvent.Callback.onKeyMultiple()}: always returns false (doesn't handle the
     * event).
     * <p>
     * Key presses in software keyboards will generally NOT trigger this listener,
     * although some may elect to do so in some situations. Do not rely on this to
     ...
     * also be implemented by setting the {@link MenuItem#setShortcut(char, char)
     ...
     * override this if they implement {@link #onCreateInputConnection(EditorInfo)}
     * to return true if a call on that method would return a non-null
     * InputConnection, and they are really a first-class editor that the user would
     * normally start typing on when the go into a window containing your view.
     *
     * <p>
     * The default implementation always returns false. This does <em>not</em> mean
     * that its {@link #onCreateInputConnection(EditorInfo)} will not be called or
     * the user can not otherwise perform edits on your view; it is just a hint to
     ...
     * The default implementation returns null, since it doesn't support input
     * methods. You can override this to implement such support. This is only needed
     * for views that take focus and text input.
     *
     * <p>
     ...
     *
     * <p>
     * Also, take good care to fill in the
     * {@link android.view.inputmethod.EditorInfo} object correctly and in its
     * entirety, so that the connected IME can rely on its values. For example,
     * {@link android.view.inputmethod.EditorInfo#initialSelStart} and
     * {@link android.view.inputmethod.EditorInfo#initialSelEnd} members must be
     * filled in with the correct cursor position for IMEs to work correctly with
     * your application.
     * </p>
     *
    ...
    /**
     * Called by the {@link android.view.inputmethod.InputMethodManager} when a view
     * who is not the current input connection target is trying to make a call on
     * the manager. The default implementation returns false; you can override this
     * to return true for certain views if you are performing InputConnection
     * proxying to them.
     * 
     ...
     * callback.
     *
     * @return Extra information about the item for which the context menu should be
     *         shown. This information will vary across different subclasses of
     *         View.
     */
     ...
     * {@link MotionEvent#getY MotionEvent.getY()}. These are normalized so that a
     ...
     * class of input that was received. Implementations of this method must examine
     * the bits in the source before processing the event. The following code
     ...
     * <p>
     * This method is called whenever a pointer is hovering into, over, or out of
     * the bounds of a view and the view is not currently being touched. Hover
     * events are represented as pointer events with action
     ...
     * {@link MotionEvent#ACTION_HOVER_ENTER} when the pointer enters the bounds of
     * the view.</li>
     * <li>The view receives a hover event with action
     * {@link MotionEvent#ACTION_HOVER_MOVE} when the pointer has already entered
     * the bounds of the view and has moved.</li>
     * <li>The view receives a hover event with action
     * {@link MotionEvent#ACTION_HOVER_EXIT} when the pointer has exited the bounds
     * of the view or when the pointer is about to go down due to a button click,
     * tap, or similar user action that causes the view to be touched.</li>
     * </ul>
     * <p>
     ...
     * </p>
     * <p>
     * The default implementation calls {@link #setHovered} to update the hovered
    ...
    public boolean onHoverEvent(MotionEvent event) {
        // The root view may receive hover (or touch) events that are outside the bounds
        // of
        ...
        if ((action == MotionEvent.ACTION_HOVER_ENTER || action == MotionEvent.ACTION_HOVER_MOVE)
                && event.isFromSource(InputDevice.SOURCE_MOUSE) && isOnScrollbar(event.getX(), event.getY())) {
            awakenScrollBars();
        }
        if (isHoverable()) {
            switch (action) {
     ...
     * the view to react to hover by using different drawable resources to change
     * its appearance.
     * </p>
     * <p>
     ...
     * <p>
     * This method is called whenever the hover state changes as a result of a call
     * to {@link #setHovered}.
     * </p>
     *
     ...
     * @param event The motion event.
     *
     * @return true if the event was handled as a scroll bar dragging, false
     *         otherwise.
     */
    protected boolean handleScrollBarDragging(MotionEvent event) {
        ...
        if ((mScrollCache.mScrollBarDraggingState == ScrollabilityCache.NOT_DRAGGING
                && action != MotionEvent.ACTION_DOWN) || !event.isFromSource(InputDevice.SOURCE_MOUSE)
        ...
        case MotionEvent.ACTION_MOVE:
            ...
            if (mScrollCache.mScrollBarDraggingState == ScrollabilityCache.DRAGGING_VERTICAL_SCROLL_BAR) {
                ...
                final int thumbLength = ScrollBarUtils.getThumbLength(bounds.height(), bounds.width(), extent, range);
                final int thumbOffset = ScrollBarUtils.getThumbOffset(bounds.height(), thumbLength, extent, range,
                        offset);
                ...
                if (Math.round(newThumbOffset) != thumbOffset && maxThumbOffset > 0 && height > 0 && extent > 0) {
                    final int newY = Math
                            .round((range - extent) / ((float) extent / height) * (newThumbOffset / maxThumbOffset));
                    if (newY != getScrollY()) {
            ...
            if (mScrollCache.mScrollBarDraggingState == ScrollabilityCache.DRAGGING_HORIZONTAL_SCROLL_BAR) {
                ...
                final int thumbLength = ScrollBarUtils.getThumbLength(bounds.width(), bounds.height(), extent, range);
                final int thumbOffset = ScrollBarUtils.getThumbOffset(bounds.width(), thumbLength, extent, range,
                        offset);
                ...
                if (Math.round(newThumbOffset) != thumbOffset && maxThumbOffset > 0 && width > 0 && extent > 0) {
                    final int newX = Math
                            .round((range - extent) / ((float) extent / width) * (newThumbOffset / maxThumbOffset));
                    if (newX != getScrollX()) {
     ...
     * actions be performed by implementing and calling {@link #performClick()}.
     ...
     * you don't want it to come up if they press and then move around enough to
     * cause scrolling.
     */
    public void cancelLongPress() {
        ...
        /*
         * The prepressed state handled by the tap callback is a display construct, but
         * the tap callback will post a long press callback less its own timeout. Remove
         * it here.
         */
        removeTapCallback();
    }
     ...
     *
     * Until this View receives a corresponding {@link MotionEvent#ACTION_UP}, ask
     * that the input system not batch {@link MotionEvent}s but instead deliver them
     * as soon as they're available. This method should only be called for touch
     * events.
     *
     * <p class="note">
     * This api is not intended for most applications. Buffered dispatch provides
     * many of benefits, and just requesting unbuffered dispatch on most MotionEvent
     * streams will not improve your input latency. Side effects include: increased
     * latency, jittery scrolls and inability to take advantage of system
     * resampling. Talk to your input professional to see if
     * {@link #requestUnbufferedDispatch(MotionEvent)} is right for you.
     * </p>
     */
    public final void requestUnbufferedDispatch(MotionEvent event) {
        final int action = event.getAction();
        if (mAttachInfo == null || action != MotionEvent.ACTION_DOWN && action != MotionEvent.ACTION_MOVE
                || !event.isTouchEvent()) {
            return;
        }
    ...
    void setFlags(int flags, int mask) {
        ...
        if (((changed & FOCUSABLE_MASK) != 0) && ((privateFlags & PFLAG_HAS_BOUNDS) != 0)) {
            if (((old & FOCUSABLE_MASK) == FOCUSABLE) && ((privateFlags & PFLAG_FOCUSED) != 0)) {
                ...
                /*
                 * Tell the view system that we are now available to take focus if no one else
                 * already has it.
                 */
                if (mParent != null)
        ...
        if (newVisibility == VISIBLE) {
            if ((changed & VISIBILITY_MASK) != 0) {
                /*
                 * If this view is becoming visible, invalidate it in case it changed while it
                 * was not visible. Marking it drawn ensures that the invalidation will go
                 * through.
                 */
        ...
        if ((changed & INVISIBLE) != 0) {
            needGlobalAttributesUpdate(false);
            /*
             * If this view is becoming invisible, set the DRAWN flag so that the next
             * invalidate() will not be skipped.
             */
            mPrivateFlags |= PFLAG_DRAWN;
        ...
        if (accessibilityEnabled) {
            if ((changed & FOCUSABLE_MASK) != 0 || (changed & VISIBILITY_MASK) != 0 || (changed & CLICKABLE) != 0
                    || (changed & LONG_CLICKABLE) != 0 || (changed & CONTEXT_CLICKABLE) != 0) {
     ...
     * {@link android.os.Build.VERSION_CODES#KITKAT} this method should be followed
     * by calls to {@link #requestLayout()} and {@link View#invalidate()} on the
     * view's parent to force the parent to redraw with the new child ordering.
     *
     ...
     * displayed part of your view. You do not need to draw any pixels above it,
     * since those are outside of the frame of your view on screen.
     *
     ...
     * These bounds do not account for any transformation properties currently set
     * on the view, such as {@link #setScaleX(float)} or
     * {@link #setRotation(float)}.
     *
    ...
    /**
     * Return the full width measurement information for this view as computed by
     * the most recent call to {@link #measure(int, int)}. This result is a bit mask
     * as defined by {@link #MEASURED_SIZE_MASK} and
     * {@link #MEASURED_STATE_TOO_SMALL}. This should be used during measurement and
    ...
    /**
     * Return the full height measurement information for this view as computed by
     * the most recent call to {@link #measure(int, int)}. This result is a bit mask
     * as defined by {@link #MEASURED_SIZE_MASK} and
     * {@link #MEASURED_STATE_TOO_SMALL}. This should be used during measurement and
     * layout calculations only. Use {@link #getHeight()} to see how wide a view is
     * after layout.
     *
     * @return The measured width of this view as a bit mask.
     */
     ...
     * {@link #getMeasuredHeightAndState()}, combined into one integer. The width
     * component is in the regular bits {@link #MEASURED_STATE_MASK} and the height
     * component is at the shifted bits
    ...
    /**
     * Returns true if the transform matrix is the identity matrix. Recomputes the
     * matrix if necessary.
     *
    ...
    /**
     * Utility method to retrieve the inverse of the current mMatrix property. We
     * cache the matrix to avoid recalculating it when transform properties have not
     * changed.
     *
     ...
     * views are drawn) from the camera to this view. The camera's distance affects
     * 3D transformations, for instance rotations around the X and Y axis. If the
     * rotationX or rotationY properties are changed and this view is large (more
     * than half the size of the screen), it is recommended to always use a camera
     * distance that's greater than the height (X axis rotation) or the width (Y
     * axis rotation) of this view.
     * </p>
     *
     * <p>
    ...
    /**
     * Sets the degrees that the view is rotated around the vertical axis through
     * the pivot point. Increasing values result in counter-clockwise rotation from
     * the viewpoint of looking down the y axis.
     *
     ...
     * proportion of the view's unscaled width. A value of 1 means that no scaling
     * is applied.
     *
     ...
     * proportion of the view's unscaled height. A value of 1, the default, means
     * that no scaling is applied.
     *
     * <p>
     * By default, this is 1.0f.
     ...
     * {@link #setRotation(float) rotated} and {@link #setScaleX(float) scaled}. By
     * default, the pivot point is centered on the object. Setting this property
     * disables this behavior and causes the view to use only the explicitly set
     * pivotX and pivotY values.
     *
     ...
     * {@link #setRotation(float) rotated} and {@link #setScaleY(float) scaled}. By
     * default, the pivot point is centered on the object. Setting this property
     * disables this behavior and causes the view to use only the explicitly set
     * pivotX and pivotY values.
     *
    ...
    /**
     * The opacity of the view. This is a value from 0 to 1, where 0 means the view
     ...
     * {@link #hasOverlappingRendering()} for more details on this behavior).
     * Calling this method is an alternative to overriding
     * {@link #hasOverlappingRendering()} in a subclass, providing the value which
     * is then used internally. That is, when
     * {@link #forceHasOverlappingRendering(boolean)} is called, the value of
     * {@link #hasOverlappingRendering()} is ignored and the value passed into this
     * method is used instead.
     *
     * @param hasOverlappingRendering The value for overlapping rendering to be used
     *                                internally instead of that returned by
     *                                {@link #hasOverlappingRendering()}.
     *
    ...
    /**
     * Returns the value for overlapping rendering that is used internally. This is
     * either the value passed into {@link #forceHasOverlappingRendering(boolean)},
     * if called, or the return value of {@link #hasOverlappingRendering()},
     * otherwise.
     *
     ...
     * optimization when alpha is set on a view. If rendering overlaps in a view
     * with alpha < 1, that view is drawn to an offscreen buffer and then composited
     * into place, which can be expensive. If the view has no overlapping rendering,
     * the view can draw each primitive with the appropriate alpha value directly.
     * An example of overlapping rendering is a TextView with a background image,
     * such as a Button. An example of non-overlapping rendering is a TextView with
     * no background, or an ImageView with only the foreground image. The default
     * implementation returns true; subclasses should override if they have cases
     * which can be optimized.
     * </p>
     *
     * <p>
     * The current implementation of the saveLayer and saveLayerAlpha methods in
     * {@link Canvas} necessitates that a View return true if it uses the methods
     * internally without passing the {@link Canvas#CLIP_TO_LAYER_SAVE_FLAG}.
     * </p>
     *
     * <p>
     * <strong>Note:</strong> The return value of this method is ignored if
     * {@link #forceHasOverlappingRendering(boolean)} has been called on this view.
     * </p>
     *
    ...
    /**
     * Sets the opacity of the view to a value from 0 to 1, where 0 means the view
     * is completely transparent and 1 means the view is completely opaque.
     *
     * <p class="note">
     * <strong>Note:</strong> setting alpha to a translucent value (0 < alpha < 1)
     * can have significant performance implications, especially for large views. It
     * is best to use the alpha property sparingly and transiently, as in the case
     * of fading animations.
     * </p>
     *
     * <p>
     * For a view with a frequently changing alpha, such as during a fading
     * animation, it is strongly recommended for performance reasons to either
     * override {@link #hasOverlappingRendering()} to return <code>false</code> if
     * appropriate, or setting a {@link #setLayerType(int, android.graphics.Paint)
     * layer type} on the view for the duration of the animation. On versions
     * {@link android.os.Build.VERSION_CODES#M} and below, the default path for
     * rendering an unlayered View with alpha could add multiple milliseconds of
     * rendering cost, even for simple or small views. Starting with
     * {@link android.os.Build.VERSION_CODES#M}, {@link #LAYER_TYPE_HARDWARE} is
     * automatically applied to the view at the rendering level.
     * </p>
     *
     * <p>
     * If this view overrides {@link #onSetAlpha(int)} to return true, then this
     * view is responsible for applying the opacity itself.
     * </p>
     *
     * <p>
     * On versions {@link android.os.Build.VERSION_CODES#LOLLIPOP_MR1} and below,
     * note that if the view is backed by a
     * {@link #setLayerType(int, android.graphics.Paint) layer} and is associated
     * with a {@link #setLayerPaint(android.graphics.Paint) layer paint}, setting an
     * alpha value less than 1.0 will supersede the alpha of the layer paint.
     * </p>
     *
     * <p>
     * Starting with {@link android.os.Build.VERSION_CODES#M}, setting a translucent
     * alpha value will clip a View to its bounds, unless the View returns
     * <code>false</code> from {@link #hasOverlappingRendering}.
     * </p>
     *
     ...
     * no calls to invalidate(). The caller of this function should perform proper
     * invalidation on the parent and this object. The return value indicates
     * whether the subclass handles alpha (the return value for onSetAlpha()).
     *
     * @param alpha The new value for the alpha property
     * @return true if the View subclass handles alpha (the return value for
     *         onSetAlpha()) and the new value for the alpha property is different
     *         from the old value
     */
    ...
    /**
     * This property is hidden and intended only for use by the Fade transition,
     * which animates it to produce a visual translucency that does not side-effect
     * (or get affected by) the real alpha property. This value is composited with
     * the other alpha value (and the AlphaAnimation value, when that is present) to
     * produce a final visual translucency result, which is what is passed into the
     * DisplayList.
     *
     * @hide
     */
     ...
     * actual alpha value and the transitionAlpha value (if set).
     */
     ...
     * setting the {@link #setTranslationX(float) translationX} property to be the
     * difference between the x value passed in and the current {@link #getLeft()
     * left} property.
     *
     ...
     * setting the {@link #setTranslationY(float) translationY} property to be the
     * difference between the y value passed in and the current {@link #getTop()
     * top} property.
     *
    ...
    /**
     * Sets the visual z position of this view, in pixels. This is equivalent to
     * setting the {@link #setTranslationZ(float) translationZ} property to be the
     * difference between the x value passed in and the current
     * {@link #getElevation() elevation} property.
     *
    ...
    /**
     * The horizontal location of this view relative to its {@link #getLeft() left}
     * position. This position is post-layout, in addition to wherever the object's
     * layout placed it.
     *
     * @return The horizontal position of this view relative to its left position,
     *         in pixels.
     */
    @ViewDebug.ExportedProperty(category = "drawing")
    ...
    /**
     * Sets the horizontal location of this view relative to its {@link #getLeft()
     * left} position. This effectively positions the object post-layout, in
     * addition to wherever the object's layout placed it.
     *
     * @param translationX The horizontal position of this view relative to its left
     *                     position, in pixels.
     *
     * @attr ref android.R.styleable#View_translationX
     */
    ...
    /**
     * The vertical location of this view relative to its {@link #getTop() top}
     * position. This position is post-layout, in addition to wherever the object's
     * layout placed it.
     *
     * @return The vertical position of this view relative to its top position, in
     *         pixels.
     */
    @ViewDebug.ExportedProperty(category = "drawing")
    ...
    /**
     * Sets the vertical location of this view relative to its {@link #getTop() top}
     * position. This effectively positions the object post-layout, in addition to
     * wherever the object's layout placed it.
     *
     * @param translationY The vertical position of this view relative to its top
     *                     position, in pixels.
     *
     * @attr ref android.R.styleable#View_translationY
     */
    ...
    /**
     * The depth location of this view relative to its {@link #getElevation()
     * elevation}.
     *
    ...
    /**
     * Sets the depth location of this view relative to its {@link #getElevation()
     * elevation}.
     *
     * @attr ref android.R.styleable#View_translationZ
     */
     ...
     * <p>
     * Note that this flag will only be respected if the View's Outline returns true
     * from {@link Outline#canClip()}.
     *
    ...
    /**
     * Sets whether the View's Outline should be used to clip the contents of the
     * View.
     * <p>
     * Only a single non-rectangular clip can be applied on a View at any time.
     * Circular clips from a
    ...
    /**
     * Sets the {@link ViewOutlineProvider} of the view, which generates the Outline
     * that defines the shape of the shadow it casts, and enables outline clipping.
     * <p>
     * The default ViewOutlineProvider, {@link ViewOutlineProvider#BACKGROUND},
     * queries the Outline from the View's background drawable, via
     * {@link Drawable#getOutline(Outline)}. Changing the outline provider with this
     * method allows this behavior to be overridden.
     * <p>
     * If the ViewOutlineProvider is null, if querying it for an outline returns
     * false, or if the produced Outline is {@link Outline#isEmpty()}, shadows will
     * not be cast.
     * <p>
     * Only outlines that return true from {@link Outline#canClip()} may be used for
     * clipping.
     *
     * @see #setClipToOutline(boolean)
     * @see #getClipToOutline()
    ...
    /**
     * Returns the current {@link ViewOutlineProvider} of the view, which generates
     * the Outline that defines the shape of the shadow it casts, and enables
     * outline clipping.
     *
     * @see #setOutlineProvider(ViewOutlineProvider)
     */
    ...
    /**
     * Called to rebuild this View's Outline from its {@link ViewOutlineProvider
     * outline provider}
     *
     * @see #setOutlineProvider(ViewOutlineProvider)
     */
     ...
     * outline without invalidating the view itself. This is intended to be called
     * from within methods in the View class itself which are the result of the view
     * being invalidated already. For example, when we are drawing the background of
     * a View, we invalidate the outline in case it changed in the meantime, but we
     * do not need to invalidate the view because we're already drawing the
     * background as part of drawing the view in response to an earlier invalidation
     * of the view.
     */
    private void rebuildOutline() {
        // Unattached views ignore this signal, and outline is recomputed in
        // onAttachedToWindow()
        if (mAttachInfo == null)
            return;
     ...
     * {@link #getDrawingRect(android.graphics.Rect)}) of the view. However, if your
     * view maintains some idea of internal selection, such as a cursor, or a
     ...
     * that area in r in global (root) coordinates. To convert r to local
     * coordinates (without taking possible View rotations into account), offset it
     * by -globalOffset (e.g. r.offset(-globalOffset.x, -globalOffset.y)). If the
     * view is completely clipped or translated out, return false.
     *
     * @param r            If true is returned, r holds the global coordinates of
     *                     the visible portion of this view.
     * @param globalOffset If true is returned, globalOffset holds the dx,dy between
     *                     this view and its root. globalOffet may be null.
     * @return true if r is non-empty (i.e. part of the view is visible at the root
     *         level.
     */
     ...
     * parameters. These supply parameters to the <i>parent</i> of this view
     * specifying how it should be arranged. There are many subclasses of
     * ViewGroup.LayoutParams, and these correspond to the different subclasses of
     * ViewGroup that are responsible for arranging their children.
     *
     * This method may return null if this View is not attached to a parent
     * ViewGroup or {@link #setLayoutParams(android.view.ViewGroup.LayoutParams)}
     * was not invoked successfully. When a View is attached to a parent ViewGroup,
     * this method must not return null.
     *
     * @return The LayoutParams associated with this view, or null if no parameters
     *         have been set yet
     */
     ...
     * to the <i>parent</i> of this view specifying how it should be arranged. There
     * are many subclasses of ViewGroup.LayoutParams, and these correspond to the
     * different subclasses of ViewGroup that are responsible for arranging their
     * children.
     *
    ...
    /**
     * <p>
     * Trigger the scrollbars to draw. When invoked this method starts an animation
     * to fade the scrollbars out after a default delay. If a subclass provides
     * animated scrolling, the start delay should equal the duration of the
     * scrolling animation.
     * </p>
     *
     * <p>
     * The animation starts only if at least one of the scrollbars is enabled, as
     * specified by {@link #isHorizontalScrollBarEnabled()} and
     * {@link #isVerticalScrollBarEnabled()}. When the animation is started, this
     * method returns true, and false otherwise. If the animation is started, this
     * method calls {@link #invalidate()}; in that case the caller should not call
     * {@link #invalidate()}.
     * </p>
     *
     * <p>
    ...
    /**
     * Trigger the scrollbars to draw. This method differs from awakenScrollBars()
     * only in its default duration. initialAwakenScrollBars() will show the scroll
     * bars for longer than usual to give the user more of a chance to notice them.
     *
     * @return true if the animation is played, false otherwise.
     */
     ...
     * <p>
     * Trigger the scrollbars to draw. When invoked this method starts an animation
     * to fade the scrollbars out after a fixed delay. If a subclass provides
     * animated scrolling, the start delay should equal the duration of the
     * scrolling animation.
     * </p>
     *
     ...
     * {@link #isVerticalScrollBarEnabled()}. When the animation is started, this
     * method returns true, and false otherwise. If the animation is started, this
     * method calls {@link #invalidate()} if the invalidate parameter is set to
     * true; in that case the caller should not call {@link #invalidate()}.
     * </p>
     *
     * <p>
     * This method should be invoked every time a subclass directly updates the
    ...
    /**
     * Do not invalidate views which are not visible and which are not running an
     * animation. They will not get drawn and they should not set dirty flags as if
     * they will be drawn
     */
     ...
     * {@link #onDraw(android.graphics.Canvas)} will be called at some point in the
     * future.
     * <p>
     * This must be called from a UI thread. To call from a non-UI thread, call
     * {@link #postInvalidate()}.
     ...
     * causes the drawing cache to be invalidated, but this function can be called
     * with invalidateCache set to false to skip that invalidation step for cases
     * that do not need it (for example, a component that remains at the same
     * dimensions with the same content).
     *
     * @param invalidateCache Whether the drawing cache for this view should be
     *                        invalidated as well. This is usually true for a full
     *                        invalidate, but may be set to false if the View's
     *                        contents or dimensions have not changed.
     */
     ...
     *
     * This method will guarantee that any changes to shadows cast by a View are
     * damaged on the screen for future redraw.
     */
    ...
    /**
     * Quick invalidation for View property changes (alpha, translationXY, etc.). We
     * don't want to set any flags or handle all of the cases handled by the default
     * invalidation methods. Instead, we just want to schedule a traversal in
     * ViewRootImpl with the appropriate dirty rect. This method calls into fast
     * invalidation methods in ViewGroup that walk up the hierarchy, transforming
     * the dirty rect as necessary.
     *
     * The method also handles normal invalidation logic if display list properties
     * are not being used in this view. The invalidateParent and forceRedraw flags
     * are used by that backup approach, to handle these cases used in the various
     * property-setting methods.
     *
     * @param invalidateParent Force a call to invalidateParentCaches() if display
     *                         list properties are not being used in this view
     * @param forceRedraw      Mark the view as DRAWN to force the invalidation to
     *                         propagate, if display list properties are not being
     *                         used in this view
     */
     ...
     * scaleX/Y, and rotation/X/Y. This method only clears the parent caches and
     * does not causes an invalidate event.
     *
     * @hide
     */
     ...
     * hardware-accelerated), which is necessary when various parent-managed
     * properties of the view change, such as alpha, translationX/Y, scrollX/Y,
     * scaleX/Y, and rotation/X/Y. This method will propagate an invalidation event
     * to the parent.
     *
     * @hide
     */
    ...
    /**
     * @return A handler associated with the thread running the View. This handler
    ...
    public void postOnAnimationDelayed(Runnable action, long delayMillis) {
        final AttachInfo attachInfo = mAttachInfo;
        if (attachInfo != null) {
            attachInfo.mViewRootImpl.mChoreographer.postCallbackDelayed(Choreographer.CALLBACK_ANIMATION, action, null,
                    delayMillis);
        } else {
            // Postpone the runnable until we know
            // on which thread it needs to run.
     ...
     *
     * @return true if this view could ask the Handler to remove the Runnable, false
     *         otherwise. When the returned value is true, the Runnable may or may
     *         not have been actually removed from the message queue (for instance,
     *         if the Runnable was not in the queue already.)
     *
     * @see #post
     * @see #postDelayed
     * @see #postOnAnimation
     ...
     *
     * <p>
     * This method can be invoked from outside of the UI thread only when this View
     ...
     * @param top               The top coordinate of the rectangle to invalidate.
     * @param right             The right coordinate of the rectangle to invalidate.
     * @param bottom            The bottom coordinate of the rectangle to
     *                          invalidate.
     *
     * @see #invalidate(int, int, int, int)
     * @see #invalidate(Rect)
     ...
     * a scroll using a {@link android.widget.Scroller Scroller} object.
     */
     ...
     * </p>
     *
     * @param horizontalFadingEdgeEnabled true if the horizontal edges should be
     *                                    faded when the view is scrolled
     *                                    horizontally
     *
     ...
     * </p>
     *
     * @param verticalFadingEdgeEnabled true if the vertical edges should be faded
     *                                  when the view is scrolled vertically
     *
     ...
     * </p>
     *
     * @param horizontalScrollBarEnabled true if the horizontal scrollbar should be
     *                                   painted
     *
     * @see #isHorizontalScrollBarEnabled()
     */
    ...
    /**
     * <p>
     * Define whether the vertical scrollbar should be drawn or not. The scrollbar
     * is not drawn by default.
     * </p>
     *
     * @param verticalScrollBarEnabled true if the vertical scrollbar should be
     *                                 painted
     *
     * @see #isVerticalScrollBarEnabled()
     */
     ...
     * <p>
     * The range is expressed in arbitrary units that must be the same as the units
     * used by {@link #computeHorizontalScrollRange()} and
     ...
     * horizontal range. This value is used to compute the length of the thumb
     * within the scrollbar's track.
     * </p>
     *
     * <p>
     ...
     * <p>
     * The range is expressed in arbitrary units that must be the same as the units
     * used by {@link #computeVerticalScrollExtent()} and
     ...
     * <p>
     * The range is expressed in arbitrary units that must be the same as the units
     * used by {@link #computeVerticalScrollRange()} and
     ...
     *                  scrolling right.
     * @return true if this view can be scrolled in the specified direction, false
     *         otherwise.
     */
     ...
     *
     * @param direction Negative to check scrolling up, positive to check scrolling
     *                  down.
     * @return true if this view can be scrolled in the specified direction, false
     *         otherwise.
     */
        ...
        if (cache != null) {
            ...
            if (mRoundScrollbarRenderer != null) {
                if (drawVerticalScrollBar) {
                    ...
                    getVerticalScrollBarBounds(bounds);
                    mRoundScrollbarRenderer.drawRoundScrollbars(canvas, (float) cache.scrollBar.getAlpha() / 255f,
                            bounds);
                    if (invalidate) {
                        invalidate();
                    }
    ...
    /**
     * <p>
     * Draw the vertical scrollbar if {@link #isVerticalScrollBarEnabled()} returns
     * true.
     * </p>
     *
     * @param canvas    the canvas on which to draw the scrollbar
    ...
    /*
     * Caller is responsible for calling requestLayout if necessary. (This allows
     * addViewInLayout to not request a new layout.)
     */
     ...
     * called before {@link #onDraw(android.graphics.Canvas)}, however it may be
     * called any time before the first onDraw -- including before or after
    ...
    public boolean resolveRtlPropertiesIfNeeded() {
        ...
        // ... then we can resolve the others properties depending on the resolved
        // LayoutDirection.
        ...
        // Should resolve Drawables before Padding because we need the layout direction
        // of the
    ...
    /**
     * This method is called whenever the state of the screen this view is attached
     * to changes. A state change will usually occurs when the screen turns on or
     * off (whether it happens automatically or the user does it manually.)
     *
     ...
     *
     * Subclasses need to override this method to take care of cached information
     * that depends on the resolved layout direction, or to inform child views that
     * inherit their layout direction.
     *
    ...
    /**
     * Reset the resolved layout direction. Layout direction will be resolved during
     * a call to {@link #onMeasure(int, int)}.
     *
     * @hide
     */
    ...
    public void resolvePadding() {
        ...
        if (!isRtlCompatibilityMode()) {
            // Post Jelly Bean MR1 case: we need to take the resolved layout direction into
            // account.
            // If start / end padding are defined, they will be resolved (hence overriding)
            // to
    ...
    /**
     * Used when we only want to reset *this* view's padding and not trigger
     * overrides in ViewGroup that reset children too.
     */
     ...
     * The super method should be called at the end of the overridden method to
     * ensure subclasses are destroyed first
     *
     * @hide
     */
    @CallSuper
    ...
    /**
     * Retrieve the {@link WindowId} for the window this view is currently attached
     * to.
     */
     ...
     * that this view is attached to. That is, this is like {@link #getWindowToken},
     ...
     * instead.
     *
     * @return Returns the associated window token, either {@link #getWindowToken()}
     ...
     *
     * @return The logical display, or null if the view is not currently attached to
     *         a window.
     */
    ...
    /**
     * Retrieve private session object this view hierarchy is using to communicate
    ...
    /**
     * @param info the {@link android.view.View.AttachInfo} to associated with this
     *             view
     */
    void dispatchAttachedToWindow(AttachInfo info, int visibility) {
        ...
        ListenerInfo li = mListenerInfo;
        final CopyOnWriteArrayList<OnAttachStateChangeListener> listeners = li != null
    ...
    /**
     * Cancel any deferred high-level input events that were previously posted to
     * the event queue.
     *
     * <p>
     * Many views post high-level events such as click handlers to the event queue
     * to run deferred in order to preserve a desired user experience - clearing
     * visible pressed states before executing, etc. This method will abort any
     * events of this nature that are currently in flight.
     * </p>
     *
     * <p>
     * Custom views that generate their own high-level deferred input events should
     * override {@link #onCancelPendingInputEvents()} and remove those pending
     ...
     *
     * <p>
     * Note that this may not be sufficient as a debouncing strategy for clicks in
     * all cases. This will not impact newer events posted after this call that may
     * occur as a result of lower-level input events still waiting in the queue. If
     * you are trying to prevent double-submitted events for the duration of some
     * sort of asynchronous transaction you should also take other steps to protect
     * against unexpected double inputs e.g. calling {@link #setEnabled(boolean)
     * setEnabled(false)} and re-enabling the view when the transaction completes,
     * tracking already submitted transaction IDs, etc.
     * </p>
     */
    ...
    /**
     * Called by {@link #cancelPendingInputEvents()} to cancel input events in
     * flight. Overridden by ViewGroup to dispatch. Package scoped to prevent
     * app-side meddling.
     */
    ...
    /**
     * Called as the result of a call to {@link #cancelPendingInputEvents()} on this
     * view or a parent view.
     *
     * <p>
     * This method is responsible for removing any pending high-level input events
     * that were posted to the event queue to run later. Custom view classes that
     * post their own deferred high-level events via {@link #post(Runnable)},
     * {@link #postDelayed(Runnable, long)} or {@link android.os.Handler} should
     * override this method, call <code>super.onCancelPendingInputEvents()</code>
    ...
    /**
     * Called by {@link #saveHierarchyState(android.util.SparseArray)} to store the
     * state for this view and its children. May be overridden to modify how
     ...
     * on screen because that will be computed again when a new instance of the view
     * is placed in its view hierarchy.
     * <p>
     ...
     * had previously been generated by {@link #onSaveInstanceState}. This function
     * will never be called with a null state.
     *
    ...
    protected void onRestoreInstanceState(Parcelable state) {
        ...
        if (state != null && !(state instanceof AbsSavedState)) {
            throw new IllegalArgumentException("Wrong state class, expecting View State but " + "received "
                    ...
                    + "when two views of different type have the same id in the same hierarchy. " + "This view's id is "
     ...
     * view was added to a ViewGroup might have no effect at all. This property
     * should always be used from XML or set to true before adding this view to a
     * ViewGroup.
     * </p>
     *
     * <p>
     ...
     *
     * <p>
     * Note: if the child view uses and updates additional states which are unknown
     * to the parent, these states should not be affected by this method.
     * </p>
     *
     * @param enabled True to enable duplication of the parent's drawable state,
     *                false to disable it.
     *
     * @see #getDrawableState()
     ...
     * {@link #LAYER_TYPE_SOFTWARE} and {@link #LAYER_TYPE_HARDWARE} for more
     * information on when and how to use layers.
     * </p>
     *
     * @param layerType The type of layer to use with this view, must be one of
     *                  {@link #LAYER_TYPE_NONE}, {@link #LAYER_TYPE_SOFTWARE} or
     *                  {@link #LAYER_TYPE_HARDWARE}
     * @param paint     The paint used to compose the layer. This argument is
     *                  optional and can be null. It is ignored when the layer type
     *                  is {@link #LAYER_TYPE_NONE}
     *
     * @see #getLayerType()
     * @see #LAYER_TYPE_NONE
     * @see #LAYER_TYPE_SOFTWARE
    ...
    public void setLayerType(int layerType, @Nullable Paint paint) {
        if (layerType < LAYER_TYPE_NONE || layerType > LAYER_TYPE_HARDWARE) {
            throw new IllegalArgumentException(
                    "Layer type can only be one of: LAYER_TYPE_NONE, " + "LAYER_TYPE_SOFTWARE or LAYER_TYPE_HARDWARE");
        }
        ...
        if (layerType != LAYER_TYPE_SOFTWARE) {
            ...
            // NOTE: even if previous layer type is HW, we do this to ensure we've cleaned
            // up
    ...
    /**
     * Updates the {@link Paint} object used with the current layer (used only if
     * the current layer type is not set to {@link #LAYER_TYPE_NONE}). Changed
     * properties of the Paint provided to
     * {@link #setLayerType(int, android.graphics.Paint)} will be used the next time
     * the View is redrawn, but {@link #setLayerPaint(android.graphics.Paint)} must
     * be called to ensure that the view gets redrawn immediately.
     *
     * <p>
     * A layer is associated with an optional {@link android.graphics.Paint}
     * instance that controls how the layer is composed on screen. The following
     ...
     * {@link #setLayerType(int, android.graphics.Paint)} for more information on
     ...
     * layer. If this view's layer type is set to {@link #LAYER_TYPE_NONE}, invoking
     ...
     * <code>super.destroyHardwareResources()</code> when overriding this method.
     *
     * @hide
     */
    @CallSuper
     ...
     * next call to {@link #getDrawingCache()} or {@link #buildDrawingCache()} will
     * draw the view in a bitmap. Calling {@link #draw(android.graphics.Canvas)}
     * will not draw from the cache when the cache is enabled. To benefit from the
     * cache, you must request the drawing cache by calling
     * {@link #getDrawingCache()} and draw it on screen if the returned bitmap is
     * not null.
     * </p>
     *
     * <p>
     ...
     * hardware acceleration is turned off. When hardware acceleration is turned on,
     * enabling the drawing cache has no effect on rendering because the system uses
     * a different mechanism for acceleration which ignores the flag. If you want to
     * use a Bitmap for the view, even when hardware acceleration is enabled, see
     * {@link #setLayerType(int, android.graphics.Paint)} for information on how to
     * enable software and hardware layers.
     * </p>
     *
     * <p>
     * This API can be used to manually generate a bitmap copy of this view, by
     * setting the flag to <code>true</code> and calling {@link #getDrawingCache()}.
     * </p>
     *
    ...
    public void outputDirtyFlags(String indent, boolean clear, int clearMask) {
        Log.d("View",
                indent + this + "             DIRTY(" + (mPrivateFlags & View.PFLAG_DIRTY_MASK) + ") DRAWN("
                        + (mPrivateFlags & PFLAG_DRAWN) + ")" + " CACHE_VALID("
                        + (mPrivateFlags & View.PFLAG_DRAWING_CACHE_VALID) + ") INVALIDATED("
                        + (mPrivateFlags & PFLAG_INVALIDATED) + ")");
        if (clear) {
     ...
     * their display lists. It is called by getDisplayList() when the parent
     * ViewGroup does not need to recreate its own display list, which would happen
     * if it went through the normal draw/dispatchDraw mechanisms.
     *
     * @hide
     */
    ...
    /**
     * Gets the RenderNode for the view, and updates its DisplayList (if needed and
     * supported)
     * 
     * @hide
     */
     ...
     * is null when caching is disabled. If caching is enabled and the cache is not
     * ready, this method will create it. Calling
     * {@link #draw(android.graphics.Canvas)} will not draw from the cache when the
     * cache is enabled. To benefit from the cache, you must request the drawing
     * cache by calling this method and draw it on screen if the returned bitmap is
     * not null.
     * </p>
     *
     * <p>
     ...
     * Because this bitmap will be drawn scaled by the parent ViewGroup, the result
     * on screen might show scaling artifacts. To avoid such artifacts, you should
     * call this method by setting the auto scaling to true. Doing so, however, will
     * generate a bitmap of a different size than the view. This implies that your
     * application must be able to handle this size.
     * </p>
     *
     * @param autoScale Indicates whether the generated bitmap should be scaled
     *                  based on the current density of the screen when the
     *                  application is in compatibility mode.
     *
     ...
     * {@link #setDrawingCacheEnabled(boolean) setDrawingCacheEnabled(true)}, you
     * should cleanup the cache by calling {@link #destroyDrawingCache()}
     * afterwards.
     * </p>
     *
     * <p>
     ...
     *
     * <p>
     * You should avoid calling this method when hardware acceleration is enabled.
     * If you do not need the drawing cache bitmap, calling this method will
     * increase memory usage and cause the view to be rendered in software once,
     * thus negatively impacting performance.
     * </p>
     *
     * @see #getDrawingCache()
     * @see #destroyDrawingCache()
    ...
    private void buildDrawingCacheImpl(boolean autoScale) {
        ...
        if (width <= 0 || height <= 0 || projectedBitmapSize > drawingCacheSize) {
            if (width > 0 && height > 0) {
                Log.w(VIEW_LOG_TAG,
                        getClass().getSimpleName() + " not displayed because it is"
     ...
     * edit mode when displayed within a developer tool. For instance, if this View
     * is being drawn by a visual user interface builder, this method should return
     * true.
     *
     ...
     * edges to extend the length of the fade so that it covers pixels drawn inside
     * the padding.
     *
     ...
     * accelerated {@link android.graphics.Canvas}. For instance, if this view is
     * drawn onto an offscreen {@link android.graphics.Bitmap} and its window is
     * hardware accelerated, {@link android.graphics.Canvas#isHardwareAccelerated()}
     * will likely return false, and this method will return true.
     * </p>
     *
     * @return True if the view is attached to a window and the window is hardware
    ...
    /**
     * Sets a rectangular area on this view to which the view will be clipped when
     * it is drawn. Setting the value to null will remove the clip bounds and the
     * view will draw normally, using its full bounds.
     *
     * @param clipBounds The rectangular area, in the local coordinates of this
     *                   view, to which future drawing operations will be clipped.
     */
     ...
     *
     * @return A copy of the current clip bounds if clip bounds are set, otherwise
     *         null.
     */
     ...
     * {@code true} if successful or {@code false} if the view's clip bounds are
     * {@code null}.
     *
     * @param outRect rectangle in which to place the clip bounds of the view
     * @return {@code true} if successful or {@code false} if the view's clip bounds
     *         are {@code null}
     */
    ...
    /**
     * Utility function, called by draw(canvas, parent, drawingTime) to handle the
     * less common case of an active Animation being run on the view.
     */
    ...
    /**
     * This method is called by getDisplayList() when a display list is recorded for
     * a View. It pushes any properties to the RenderNode that aren't managed by the
     * RenderNode.
     */
    ...
    /**
     * This method is called by ViewGroup.drawChild() to have each child view draw
     * itself.
     *
    ...
    boolean draw(Canvas canvas, ViewGroup parent, long drawingTime) {
        ...
        /*
         * If an attached view draws to a HW canvas, it may use its RenderNode +
         * DisplayList.
         *
        ...
        if (drawingWithRenderNode) {
            ...
            if (!renderNode.isValid()) {
                // Uncommon, but possible. If a view is removed from the hierarchy during the
                // call
                // to getDisplayList(), the display list will be marked invalid and we should
                // not
                // try to use it again.
                renderNode = null;
     ...
     * view must have already done a full layout before this function is called.
     * When implementing a view, implement {@link #onDraw(android.graphics.Canvas)}
    ...
    public void draw(Canvas canvas) {
        ...
        /*
         * Draw traversal performs several drawing steps which must be executed in the
         * appropriate order:
         *
         * 1. Draw the background 2. If necessary, save the canvas' layers to prepare
         * for fading 3. Draw view's content 4. Draw children 5. If necessary, draw the
         * fading edges and restore layers 6. Draw decorations (scrollbars for instance)
         */
        ...
        /*
         * Here we do the full fledged routine... (this is an uncommon case where speed
         * matters less, this is why we repeat some of the tests that have been done
         * above)
         */
     ...
     * Adding drawables to the overlay will cause them to be displayed whenever the
     * view itself is redrawn. Objects in the overlay should be actively managed:
     * remove them when they should not be displayed anymore. The overlay will
     * always have the same size as its host view.
     *
     * <p>
     ...
     * color background, and needs to draw fading edges. Returning a non-zero color
     * enables the view system to optimize the drawing of the fading edges. If you
     * do return a non-zero color, the alpha should be set to 0xFF.
     *
     * @see #setVerticalFadingEdgeEnabled(boolean)
     * @see #setHorizontalFadingEdgeEnabled(boolean)
     *
     * @return The known solid color background for this view, or 0 if the color may
     *         vary
     */
    @ViewDebug.ExportedProperty(category = "drawing")
    @ColorInt
    ...
    /**
     * Build a human readable string representation of the specified private view
     * flags.
     *
    ...
    private boolean setOpticalFrame(int left, int top, int right, int bottom) {
        ...
        return setFrame(left + parentInsets.left - childInsets.left, top + parentInsets.top - childInsets.top,
                right + parentInsets.left + childInsets.right, bottom + parentInsets.top + childInsets.bottom);
    }
     ...
     * them. This is typically done using the child measurements that were stored in
     * the measure pass().
     * </p>
     *
     * <p>
     * Derived classes should not override this method. Derived classes with
     * children should override onLayout. In that method, they should call layout on
    ...
    /**
     * Same as setFrame, but public and hidden. For use in
     * {@link android.transition.ChangeBounds}.
     * 
     * @hide
     */
    ...
    public void scheduleDrawable(@NonNull Drawable who, @NonNull Runnable what, long when) {
        if (verifyDrawable(who) && what != null) {
            ...
            if (mAttachInfo != null) {
                mAttachInfo.mViewRootImpl.mChoreographer.postCallbackDelayed(Choreographer.CALLBACK_ANIMATION, what,
                        who, Choreographer.subtractFrameDelay(delay));
            } else {
                // Postpone the runnable until we know
                // on which thread it needs to run.
    ...
    /**
     * Unschedule any events associated with the given Drawable. This can be used
     * when selecting a new Drawable into a view, so that the previous one is
    ...
    protected void resolveDrawables() {
        // Drawables resolution may need to happen before resolving the layout direction
        // (which is
        // done only during the measure() call).
        // If the layout direction is not resolved yet, we cannot resolve the Drawables
        // except in
        // one case: when the raw layout direction has not been defined as
        // LAYOUT_DIRECTION_INHERIT.
        // So, if the raw layout direction is LAYOUT_DIRECTION_LTR or
        // LAYOUT_DIRECTION_RTL or
        // LAYOUT_DIRECTION_LOCALE, we can "cheat" and we don't need to wait for the
        // layout
        // direction to be resolved as its resolved value will be the same as its raw
        // value.
     ...
     * <p>
     * If the View has a StateListAnimator, it will also be called to run necessary
    ...
    /**
     * This function is called whenever the view hotspot changes and needs to be
     * propagated to drawables or child views managed by the view.
     * <p>
    ...
    /**
     * Generate the new {@link android.graphics.drawable.Drawable} state for this
     * view. This is called by the view system when the cached Drawable state is
     * determined to be invalid. To retrieve the current state, you should use
     * {@link #getDrawableState}.
     *
     * @param extraSpace if non-zero, this is the number of extra entries you would
     *                   like in the returned array in which you can place your own
     *                   states.
     *
     * @return Returns an array holding the current {@link Drawable} state of the
     *         view.
     *
    ...
    protected int[] onCreateDrawableState(int extraSpace) {
        ...
        if (false) {
            ...
            Log.i("View",
                    toString() + " pressed=" + ((privateFlags & PFLAG_PRESSED) != 0) + " en="
    ...
    /**
     * Merge your own state values in <var>additionalState</var> into the base state
     * values <var>baseState</var> that were returned by
     * {@link #onCreateDrawableState(int)}.
     *
     * @param baseState       The base state values returned by
     *                        {@link #onCreateDrawableState(int)}, which will be
     *                        modified to also hold your own additional state
     *                        values.
     *
    ...
    /**
     * Call {@link Drawable#jumpToCurrentState() Drawable.jumpToCurrentState()} on
     * all Drawable objects associated with this view.
     * <p>
     * Also calls {@link StateListAnimator#jumpToCurrentState()} if there is a
     * StateListAnimator attached to this view.
     */
    @CallSuper
     ...
     *
     * @param background The Drawable to use as the background, or null to remove
     *                   the background
     */
    ...
    public void setBackgroundDrawable(Drawable background) {
        ...
        /*
         * Regardless of whether we're setting a new background or not, we want to clear
         * the previous drawable. setVisible first while we still have the callback set.
         */
        if (mBackground != null) {
            if (isAttachedToWindow()) {
        ...
        if (background != null) {
            ...
            // Compare the minimum sizes of the old Drawable and the new. If there isn't an
            // old or
            ...
            // background drawable state change calls. In particular, the setVisible call
            // below
            // can result in drawables attempting to start animations or otherwise
            // invalidate,
            ...
            /*
             * When the background is set, we try to apply its padding to this View. When
             * the background is removed, we don't touch this View's padding. This is noted
             * in the Javadocs. Hence, we don't need to requestLayout(), the invalidate()
             * below is sufficient.
             */
     ...
     *
     * @param tintMode the blending mode used to apply the tint, may be {@code null}
     *                 to clear tint
    ...
    /**
     * Returns the drawable used as the foreground of this View. The foreground
     * drawable, if non-null, is always drawn on top of the view's content.
     *
    ...
    /**
     * Supply a Drawable that is to be rendered on top of all of the content in the
     * view.
     *
    ...
    /**
     * Magic bit used to support features of framework-internal window decor
     * implementation details. This used to live exclusively in FrameLayout.
     *
     ...
     * @hide internal use only; only used by FrameLayout and internal screen
     *       layouts.
     */
    ...
    public ColorStateList getForegroundTintList() {
        return mForegroundInfo != null && mForegroundInfo.mTintInfo != null ? mForegroundInfo.mTintInfo.mTintList
                : null;
    }

    /**
     * Specifies the blending mode used to apply the tint specified by
     * {@link #setForegroundTintList(ColorStateList)}} to the background drawable.
     * The default mode is {@link PorterDuff.Mode#SRC_IN}.
     *
     * @param tintMode the blending mode used to apply the tint, may be {@code null}
     *                 to clear tint
    ...
    public PorterDuff.Mode getForegroundTintMode() {
        return mForegroundInfo != null && mForegroundInfo.mTintInfo != null ? mForegroundInfo.mTintInfo.mTintMode
                : null;
    }
     ...
     *
     * <p>
     * Foreground content may consist of scroll bars, a {@link #setForeground
     * foreground} drawable or other view-specific decorations. The foreground is
     * drawn on top of the primary view content.
     * </p>
     *
    ...
    public void onDrawForeground(Canvas canvas) {
        ...
        if (foreground != null) {
            if (mForegroundInfo.mBoundsChanged) {
                ...
                Gravity.apply(mForegroundInfo.mGravity, foreground.getIntrinsicWidth(), foreground.getIntrinsicHeight(),
     ...
     * values returned from {@link #getPaddingLeft}, {@link #getPaddingTop},
     * {@link #getPaddingRight} and {@link #getPaddingBottom} may be different from
     * the values set in this call.
     *
     * @attr ref android.R.styleable#View_padding
     * @attr ref android.R.styleable#View_paddingBottom
     * @attr ref android.R.styleable#View_paddingLeft
     ...
     * the scrollbars, depending on the style and visibility of the scrollbars. So
     * the values returned from {@link #getPaddingStart}, {@link #getPaddingTop},
     * {@link #getPaddingEnd} and {@link #getPaddingBottom} may be different from
     * the values set in this call.
     *
     * @attr ref android.R.styleable#View_padding
     * @attr ref android.R.styleable#View_paddingBottom
     ...
     *
     * <p>
     * This method should be treated similarly to setMeasuredDimension and not as a
     * general property. Views that compute their own optical insets should call it
     * as part of measurement. This method does not request layout. If you are
     * setting optical insets outside of measure/layout itself you will want to call
     * requestLayout() yourself.
     * </p>
     * 
     * @hide
     */
     ...
     * Note that activation is not the same as selection. Selection is a transient
     * property, representing the view (hierarchy) the user is currently interacting
     * with. Activation is a longer-term state that the user can move views in and
     * out of. For example, in a list view with single or multiple selection
     * enabled, the views in the current selection set are activated. (Um, yeah, we
     * are deeply sorry about the terminology here.) The activated state is
     * propagated down to children of the view it is set on.
     *
     ...
     * observer can be used to get notifications when global events, like layout,
     * happen.
     *
     ...
     * @param childToSkip If not null, ignores this child during the recursive
     *                    traversal.
     ...
     * obtain the event source. Also accessibility ids are guaranteed to be unique
     * in the window.
     *
    ...
    /**
     * {@hide} Look for a child view that matches the specified predicate. If this
     * view matches the predicate, return this view.
     *
     * @param predicate The predicate to evaluate.
     * @return The first view that matches the predicate or null.
     */
    ...
    /**
     * {@hide} Look for a child view that matches the specified predicate, starting
     * with the specified view and its descendents and then recusively searching the
     * ancestors and siblings of that view until this view is reached.
     *
     * This method is useful in cases where the predicate does not match a single
     * unique view (perhaps multiple views use the same id) and we are trying to
     * find the view that is "closest" in scope to the starting view.
     *
    ...
    /**
     * Sets the identifier for this view. The identifier does not have to be unique
     * in this view's hierarchy. The identifier should be a positive number.
     *
     * @see #NO_ID
     * @see #getId()
     ...
     *
     * @return a positive integer used to identify the view or {@link #NO_ID} if the
     *         view has no ID
     *
     * @see #setId(int)
     * @see #findViewById(int)
    ...
    /**
     * Sets the tag associated with this view. A tag can be used to mark a view in
     * its hierarchy and does not have to be unique within the hierarchy. Tags can
     * also be used to store data within a view without resorting to another data
     * structure.
     *
     ...
     * view in its hierarchy and does not have to be unique within the hierarchy.
     * Tags can also be used to store data within a view without resorting to
     * another data structure.
     *
     * The specified key should be an id declared in the resources of the
     * application to ensure it is unique (see the
     * <a href="{@docRoot}guide/topics/resources/more-resources.html#Id">ID resource
     * type</a>). Keys identified as belonging to the Android framework or not
     * associated with any package will cause an {@link IllegalArgumentException} to
     * be thrown.
     *
     * @param key The key identifying the tag
     * @param tag An Object to tag the view with
    ...
    protected void debug(int depth) {
        ...
        output += "frame={" + mLeft + ", " + mTop + ", " + mRight + ", " + mBottom + "} scroll={" + mScrollX + ", "
                + mScrollY + "} ";
        Log.d(VIEW_LOG_TAG, output);
     ...
     * ({@link #isInLayout()}. If layout is happening, the request may be honored at
    ...
    public final void measure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (forceLayout || needsLayout) {
            ...
            if ((mPrivateFlags & PFLAG_MEASURED_DIMENSION_SET) != PFLAG_MEASURED_DIMENSION_SET) {
                throw new IllegalStateException(
                        "View with id " + getId() + ": " + getClass().getName() + "#onMeasure() did not set the"
     ...
     * call {@link #setMeasuredDimension(int, int)} to store the measured width and
     ...
     * override {@link #onMeasure(int, int)} to provide better measurements of their
     * content.
     * </p>
     *
     * <p>
     ...
     * width ({@link #getSuggestedMinimumHeight()} and
     ...
     * @param measuredHeight The measured height of this view. May be a complex bit
     *                       mask as defined by {@link #MEASURED_SIZE_MASK} and
     *                       {@link #MEASURED_STATE_TOO_SMALL}.
     */
    ...
    /**
     * Sets the measured dimension without extra processing for things like optical
     * bounds. Useful for reapplying consistent values that have already been cooked
     * with adjustments for optical bounds, etc. such as those from the measurement
     * cache.
     *
     * @param measuredWidth  The measured width of this view. May be a complex bit
     *                       mask as defined by {@link #MEASURED_SIZE_MASK} and
     ...
     * MeasureSpec. Will take the desired size, unless a different size is imposed
     * by the constraints. The returned value is a compound integer, with the
     * resolved size in the {@link #MEASURED_SIZE_MASK} bits and optionally the bit
     * {@link #MEASURED_STATE_TOO_SMALL} set if the resulting size is smaller than
     * the size the view wants to be.
     *
     * @param size               How big the view wants to be.
     * @param measureSpec        Constraints imposed by the parent.
     * @param childMeasuredState Size information bit mask for the view's children.
     * @return Size information bit mask as defined by {@link #MEASURED_SIZE_MASK}
    ...
    /**
     * Returns the suggested minimum height that the view should use. This returns
     * the maximum of the view's minimum height and the background's minimum height
    ...
    /**
     * Returns the suggested minimum width that the view should use. This returns
     * the maximum of the view's minimum width and the background's minimum width
    ...
    /**
     * Sets the minimum height of the view. It is not guaranteed the view will be
     * able to achieve this minimum height (for example, if its parent layout
     ...
     *
     * @return The animation that is currently playing or scheduled to play for this
     *         view.
     */
     ...
     * invalidation, but you must make sure that 1) the animation has a start time
     * set, and 2) the view's parent (which controls animations on its children)
     ...
     * alpha when their onDraw() is called. If this returns false then the view may
     * be redirected to draw into an offscreen buffer to fulfill the request, which
     * will look fine, but may be slower than if the subclass handles it internally.
     ...
     * considered transparent, but its children are not, therefore all View objects
     * remove themselves from the global transparent region (passed as a parameter
     * to this function).
     *
     * @param region The transparent region for this ViewAncestor (window).
     *
     * @return Returns true if the effective visibility of the view at this point is
     *         opaque, regardless of the transparent region; returns false if it is
    ...
    public boolean gatherTransparentRegion(Region region) {
        ...
        if (region != null && attachInfo != null) {
            ...
            if ((pflags & PFLAG_SKIP_DRAW) == 0) {
                ...
                getLocationInWindow(location);
                // When a view has Z value, then it will be better to leave some area below the
                // view
                // for drawing shadow. The shadow outset is proportional to the Z value. Note
                // that
                // the bottom part needs more offset than the left, top and right parts due to
                // the
                // spot light effects.
                int shadowOffset = getZ() > 0 ? (int) getZ() : 0;
                region.op(location[0] - shadowOffset, location[1] - shadowOffset,
                        location[0] + mRight - mLeft + shadowOffset, location[1] + mBottom - mTop + (shadowOffset * 3),
     ...
     *
     * @param soundConstant One of the constants defined in
     *                      {@link SoundEffectConstants}
     */
     ...
     *
     * <p>
     * The feedback will only be performed if {@link #isHapticFeedbackEnabled()} is
     * true.
     *
     ...
     * @param feedbackConstant One of the constants defined in
     *                         {@link HapticFeedbackConstants}
     * @param flags            Additional flags as per
     *                         {@link HapticFeedbackConstants}.
     */
     ...
     * with {@link Window#FEATURE_ACTION_BAR_OVERLAY
     * Window.FEATURE_ACTION_BAR_OVERLAY}, allowing the applications content to be
     * placed behind the action bar (and with these flags other system affordances)
     * so that smooth transitions between hiding and showing them can be done.
     *
     * <p>
     * Two representative examples of the use of system UI visibility is
     * implementing a content browsing application (like a magazine reader) and a
     ...
     * content-oriented mode by hiding the status bar and action bar, and putting
     * the navigation elements into lights out mode. The user can then interact with
     * content while in this mode. Such an application should provide an easy way
     * for the user to toggle out of the mode (such as to check information in the
     * status bar or access notifications). In the implementation here, this is done
     * simply by tapping on the content.
     *
     * {@sample development/samples/ApiDemos/src/com/example/android/apis/view/ContentBrowserActivity.java
     * content}
     *
     * <p>
     * This second code sample shows a typical implementation of a View in a video
     * playing application. In this situation, while the video is playing the
     ...
     * interact with the application; the system intercepts touching on the screen
     * to pop the UI out of full screen mode. See {@link #fitSystemWindows(Rect)}
     ...
     *                   {@link #SYSTEM_UI_FLAG_IMMERSIVE}, and
     ...
     * window. This is the combination of the {@link #setSystemUiVisibility(int)}
     ...
     * {@link #getWindowSystemUiVisibility()}. This is different from the callbacks
     * received through
     * {@link #setOnSystemUiVisibilityChangeListener(OnSystemUiVisibilityChangeListener)}
     * in that this is only telling you about the local request of the window, not
     * the actual values applied by the system.
     */
    ...
    /**
     * Dispatch callbacks to {@link #setOnSystemUiVisibilityChangeListener} down the
     * view hierarchy.
     */
    public void dispatchSystemUiVisibilityChanged(int visibility) {
        ListenerInfo li = mListenerInfo;
        if (li != null && li.mOnSystemUiVisibilityChangeListener != null) {
            li.mOnSystemUiVisibilityChangeListener
                    .onSystemUiVisibilityChange(visibility & PUBLIC_STATUS_BAR_VISIBILITY_MASK);
        }
    }
     ...
     * appearance as the given View. The default also positions the center of the
     * drag shadow directly under the touch point. If no View is provided (the
     * constructor with no parameters is used), and
     ...
     * basis of the drag shadow. The {@link #onDrawShadow(Canvas) onDrawShadow()}
     * method allows you to draw anything you want as the drag shadow.
     * </p>
     * <p>
     * You pass a DragShadowBuilder object to the system when you start the drag.
     * The system calls {@link #onProvideShadowMetrics(Point,Point)
     * onProvideShadowMetrics()} to get the size and position of the drag shadow. It
     * uses this data to construct a {@link android.graphics.Canvas} object, then it
     * calls {@link #onDrawShadow(Canvas) onDrawShadow()} so that your application
    ...
    public static class DragShadowBuilder {
         ...
         * drag shadow will have the same appearance and dimensions as the View, with
         * the touch point over the center of the View.
         * 
         ...
         * variant is only useful when the {@link #onProvideShadowMetrics(Point, Point)}
         * and {@link #onDrawShadow(Canvas)} methods are also overridden in order to
         ...
         * {@link #View.DragShadowBuilder(View)} constructor. If that View parameter was
         * {@code null} or if the {@link #View.DragShadowBuilder()} constructor was used
         ...
         * the shadow image, and the point within that shadow that should be centered
         * under the touch location while dragging.
         * <p>
         * The default implementation sets the dimensions of the shadow to be the same
         * as the dimensions of the View itself and centers the shadow under the touch
         * point.
         * </p>
         *
         * @param outShadowSize       A {@link android.graphics.Point} containing the
         *                            width and height of the shadow image. Your
         *                            application must set
         *                            {@link android.graphics.Point#x} to the desired
         *                            width and must set
         *                            {@link android.graphics.Point#y} to the desired
         *                            height of the image.
         *
         * @param outShadowTouchPoint A {@link android.graphics.Point} for the position
         *                            within the shadow image that should be underneath
         *                            the touch point during the drag and drop
         *                            operation. Your application must set
         *                            {@link android.graphics.Point#x} to the X
         *                            coordinate and {@link android.graphics.Point#y} to
         ...
         * {@link android.graphics.Canvas} object based on the dimensions it received
         * from the {@link #onProvideShadowMetrics(Point, Point)} callback.
         *
         * @param canvas A {@link android.graphics.Canvas} object in which to draw the
         *               shadow image.
         */
    ...
    /**
     * @deprecated Use
     *             {@link #startDragAndDrop(ClipData, DragShadowBuilder, Object, int)
     ...
     * passes a {@link android.view.View.DragShadowBuilder} object to the system.
     * The system calls this object's
     * {@link DragShadowBuilder#onProvideShadowMetrics(Point, Point)} to get metrics
     * for the drag shadow, and then calls the object's
     ...
     * listener (an implementation of
     * {@link android.view.View.OnDragListener#onDrag(View,DragEvent) onDrag()} or
     * by calling the View object's {@link android.view.View#onDragEvent(DragEvent)
     * onDragEvent()} method. Both are passed a {@link android.view.DragEvent}
     * object that has a {@link android.view.DragEvent#getAction()} value of
     * {@link android.view.DragEvent#ACTION_DRAG_STARTED}.
     * </p>
     * <p>
     * Your application can invoke
     * {@link #startDragAndDrop(ClipData, DragShadowBuilder, Object, int)
     * startDragAndDrop()} on any attached View object. The View object does not
     * need to be the one used in {@link android.view.View.DragShadowBuilder}, nor
     * does it need to be related to the View the user selected for dragging.
     * </p>
     * 
     * @param data          A {@link android.content.ClipData} object pointing to
     *                      the data to be transferred by the drag and drop
     *                      operation.
     * @param shadowBuilder A {@link android.view.View.DragShadowBuilder} object for
     *                      building the drag shadow.
     * @param myLocalState  An {@link java.lang.Object} containing local data about
     *                      the drag and drop operation. When dispatching drag
     *                      events to views in the same activity this object will be
     *                      available through
     *                      {@link android.view.DragEvent#getLocalState()}. Views in
     *                      other activities will not have access to this data
     *                      ({@link android.view.DragEvent#getLocalState()} will
     *                      return null).
     *                      <p>
     *                      myLocalState is a lightweight mechanism for the sending
     *                      information from the dragged View to the target Views.
     *                      For example, it can contain flags that differentiate
     *                      between a a copy operation and a move operation.
     *                      </p>
     * @param flags         Flags that control the drag and drop operation. This can
     *                      be set to 0 for no flags, or any combination of the
     *                      following:
     *                      <ul>
     ...
     *                      </ul>
     * @return {@code true} if the method completes successfully, or {@code false}
     *         if it fails anywhere. Returning {@code false} means the system was
     *         unable to do a drag, and so no drag operation is in progress.
     */
    public final boolean startDragAndDrop(ClipData data, DragShadowBuilder shadowBuilder, Object myLocalState,
        ...
        if (ViewDebug.DEBUG_DRAG) {
            Log.d(VIEW_LOG_TAG, "drag shadow: width=" + shadowSize.x + " height=" + shadowSize.y + " shadowX="
                    + shadowTouchPoint.x + " shadowY=" + shadowTouchPoint.y);
        }
        ...
        try {
            mAttachInfo.mDragToken = mAttachInfo.mSession.prepareDrag(mAttachInfo.mWindow, flags, shadowSize.x,
                    shadowSize.y, mAttachInfo.mDragSurface);
            if (ViewDebug.DEBUG_DRAG)
                Log.d(VIEW_LOG_TAG, "prepareDrag returned token=" + mAttachInfo.mDragToken + " surface="
            ...
            if (mAttachInfo.mDragToken != null) {
                ...
                okay = mAttachInfo.mSession.performDrag(mAttachInfo.mWindow, mAttachInfo.mDragToken,
                        root.getLastTouchSource(), shadowSize.x, shadowSize.y, shadowTouchPoint.x, shadowTouchPoint.y,
                        data);
                if (ViewDebug.DEBUG_DRAG)
     ...
     * {@link android.view.DragEvent#getResult()} value of {@code false} will be
     * sent to every View that received
     * {@link android.view.DragEvent#ACTION_DRAG_STARTED} even if they are not
     * currently visible.
     * </p>
     * <p>
     * This method can be called on any View in the same window as the View on which
     * {@link #startDragAndDrop(ClipData, DragShadowBuilder, Object, int)
     * startDragAndDrop} was called.
     * </p>
     */
    ...
    /**
     * Starts a move from {startX, startY}, the amount of the movement will be the
     * offset between {startX, startY} and the new cursor positon.
     * 
     ...
     * startDragAndDrop()}.
     * <p>
     * When the system calls this method, it passes a {@link android.view.DragEvent}
     * object. A call to {@link android.view.DragEvent#getAction()} returns one of
     * the action type constants defined in DragEvent. The method uses these to
     * determine what is happening in the drag and drop operation.
     * 
     * @param event The {@link android.view.DragEvent} sent by the system. The
     ...
     *         <p>
     *         The method should return {@code true} in response to an action type
     *         of {@link android.view.DragEvent#ACTION_DRAG_STARTED} to receive drag
     *         events for the current operation.
     *         </p>
     *         <p>
     *         The method should also return {@code true} in response to an action
     *         type of {@link android.view.DragEvent#ACTION_DROP} if it consumed the
    ...
    // Dispatches ACTION_DRAG_ENTERED and ACTION_DRAG_EXITED events for pre-Nougat
    // apps.
     ...
     * true, then it calls the drag event listener with the
    ...
    public boolean dispatchDragEvent(DragEvent event) {
        ...
        if (event.mAction == DragEvent.ACTION_DRAG_LOCATION || event.mAction == DragEvent.ACTION_DROP) {
            // About to deliver an event with coordinates to this view. Notify that now this
            // view
    ...
    /**
     * This needs to be a better API (NOT ON VIEW) before it is exposed. If it is
     * ever exposed at all.
     * 
     * @hide
     */
     ...
     * Region being computed for
     * {@link #gatherTransparentRegion(android.graphics.Region)} so that any
     * non-transparent parts of the Drawable are removed from the given transparent
     * region.
     *
     * @param dr     The Drawable whose transparency is to be applied to the region.
     * @param region A Region holding the current transparency information, where
     *               any parts of the region that are set are considered to be
     *               transparent. On return, this region will be modified to have
     *               the transparency information reduced by the corresponding parts
     *               of the Drawable that are not transparent. {@hide}
     */
     ...
     * {@link LayoutInflater} class, which provides a full range of options for view
     * inflation.
     *
     * @param context  The Context object for your activity or application.
     * @param resource The resource ID to inflate
     * @param root     A view group that will be the parent. Used to properly
     *                 inflate the layout_* parameters.
     * @see LayoutInflater
     */
     ...
     * {@link #onOverScrolled(int, int, boolean, boolean)} to respond to the results
     * of an over-scroll operation.
     *
     ...
     * view content is larger than the container), or {@link #OVER_SCROLL_NEVER}.
     *
     * Setting the over-scroll mode of a view will have an effect only if the view
     * is capable of scrolling.
     *
     ...
     * scrolling operations with a compatible parent view in the current hierarchy.
     * If this view does not implement nested scrolling this will have no effect.
     * Disabling nested scrolling while a nested scroll is in progress has the
     * effect of {@link #stopNestedScroll() stopping} the nested scroll.
     * </p>
     *
     ...
     *
     * <p>
     * If nested scrolling is enabled and this View class implementation supports
     * it, this view will act as a nested scrolling child view when applicable,
     * forwarding data about the scroll operation in progress to a compatible and
     * cooperating nested scrolling parent.
     * </p>
     *
     ...
     *
     * <p>
     * The view will call startNestedScroll upon initiating a scroll operation. In
     * the case of a touch scroll this corresponds to the initial
     * {@link MotionEvent#ACTION_DOWN}. In the case of touch scrolling the nested
     * scroll will be terminated automatically in the same manner as
     * {@link ViewParent#requestDisallowInterceptTouchEvent(boolean)}. In the event
     * of programmatic scrolling the caller must explicitly call
     * {@link #stopNestedScroll()} to indicate the end of the nested scroll.
     * </p>
     *
     * <p>
     * If <code>startNestedScroll</code> returns true, a cooperative parent was
     * found. If it returns false the caller may ignore the rest of this contract
     * until the next scroll. Calling startNestedScroll while a nested scroll is
     * already in progress will return true.
     * </p>
     *
     * <p>
     * At each incremental step of the scroll the caller should invoke
     * {@link #dispatchNestedPreScroll(int, int, int[], int[])
     * dispatchNestedPreScroll} once it has calculated the requested scrolling
     * delta. If it returns true the nested scrolling parent at least partially
     * consumed the scroll and the caller should adjust the amount it scrolls by.
     * </p>
     *
     * <p>
     * After applying the remainder of the scroll delta the caller should invoke
     * {@link #dispatchNestedScroll(int, int, int, int, int[])
     * dispatchNestedScroll}, passing both the delta consumed and the delta
     * unconsumed. A nested scrolling parent may treat these values differently. See
     * {@link ViewParent#onNestedScroll(View, int, int, int, int)}.
     * </p>
     *
     * @param axes Flags consisting of a combination of
     *             {@link #SCROLL_AXIS_HORIZONTAL} and/or
     *             {@link #SCROLL_AXIS_VERTICAL}.
     * @return true if a cooperative parent was found and nested scrolling has been
        ...
        if (isNestedScrollingEnabled()) {
            ...
            while (p != null) {
                try {
                    ...
                    Log.e(VIEW_LOG_TAG,
                            "ViewParent " + p + " does not implement interface " + "method onStartNestedScroll", e);
     ...
     *
     * <p>
     * Calling this method when a nested scroll is not currently in progress is
     * harmless.
     * </p>
     *
     ...
     * initiated a nested scroll and it was accepted by an ancestor view further up
     * the view hierarchy.
     * </p>
     *
     ...
     *
     * <p>
     * Implementations of views that support nested scrolling should call this to
     * report info about a scroll in progress to the current nested scrolling
     * parent. If a nested scroll is not currently in progress or nested scrolling
     * is not {@link #isNestedScrollingEnabled() enabled} for this view this method
     * does nothing.
     * </p>
     *
     * <p>
     ...
     * {@link #dispatchNestedPreScroll(int, int, int[], int[])
     * dispatchNestedPreScroll} before consuming a component of the scroll event
     * themselves.
     * </p>
     *
     * @param dxConsumed     Horizontal distance in pixels consumed by this view
     *                       during this scroll step
     * @param dyConsumed     Vertical distance in pixels consumed by this view
     *                       during this scroll step
     * @param dxUnconsumed   Horizontal scroll distance in pixels not consumed by
     *                       this view
     * @param dyUnconsumed   Horizontal scroll distance in pixels not consumed by
     *                       this view
     * @param offsetInWindow Optional. If not null, on return this will contain the
     *                       offset in local view coordinates of this view from
     *                       before this operation to after it completes. View
     *                       implementations may use this to adjust expected input
     *                       coordinate tracking.
     * @return true if the event was dispatched, false if it could not be
     *         dispatched.
     * @see #dispatchNestedPreScroll(int, int, int[], int[])
     */
    ...
    /**
     * Dispatch one step of a nested scroll in progress before this view consumes
     * any portion of it.
     *
     * <p>
     * Nested pre-scroll events are to nested scroll events what touch intercept is
     * to touch. <code>dispatchNestedPreScroll</code> offers an opportunity for the
     * parent view in a nested scrolling operation to consume some or all of the
     * scroll operation before the child view consumes it.
     * </p>
     *
     * @param dx             Horizontal scroll distance in pixels
     * @param dy             Vertical scroll distance in pixels
     * @param consumed       Output. If not null, consumed[0] will contain the
     *                       consumed component of dx and consumed[1] the consumed
     *                       dy.
     * @param offsetInWindow Optional. If not null, on return this will contain the
     *                       offset in local view coordinates of this view from
     *                       before this operation to after it completes. View
     ...
     *
     * <p>
     * This method should be used to indicate that a nested scrolling child has
     * detected suitable conditions for a fling. Generally this means that a touch
     * scroll has ended with a {@link VelocityTracker velocity} in the direction of
     * scrolling that meets or exceeds the
     * {@link ViewConfiguration#getScaledMinimumFlingVelocity() minimum fling
     * velocity} along a scrollable axis.
     * </p>
     *
     * <p>
     * If a nested scrolling child view would normally fling but it is at the edge
     * of its own content, it can use this method to delegate the fling to its
     * nested scrolling parent instead. The parent may optionally consume the fling
     * or observe a child fling.
     * </p>
     *
     * @param velocityX Horizontal fling velocity in pixels per second
     * @param velocityY Vertical fling velocity in pixels per second
     * @param consumed  true if the child consumed the fling, false otherwise
     * @return true if the nested scrolling parent consumed or otherwise reacted to
     *         the fling
     */
    ...
    /**
     * Dispatch a fling to a nested scrolling parent before it is processed by this
     * view.
     *
     * <p>
     * Nested pre-fling events are to nested fling events what touch intercept is to
     * touch and what nested pre-scroll is to nested scroll.
     * <code>dispatchNestedPreFling</code> offsets an opportunity for the parent
     * view in a nested fling to fully consume the fling before the child view
     * consumes it. If this method returns <code>true</code>, a nested parent view
     * consumed the fling and this view should not scroll as a result.
     * </p>
     *
     * <p>
     * For a better user experience, only one view in a nested scrolling chain
     * should consume the fling at a time. If a parent view consumed the fling this
     * method will return false. Custom view implementations should account for this
     * in two ways:
     * </p>
     *
     * <ul>
     * <li>If a custom view is paged and needs to settle to a fixed page-point, do
     * not call <code>dispatchNestedPreFling</code>; consume the fling and settle to
     * a valid position regardless.</li>
     * <li>If a nested parent does consume the fling, this view should not scroll at
     * all, even to settle back to a valid idle position.</li>
     * </ul>
     *
     * <p>
     * Views should also not offer fling velocities to nested parent views along an
     * axis where scrolling is not currently supported; a
     * {@link android.widget.ScrollView ScrollView} should not offer a horizontal
     * fling velocity to its parents since scrolling along that axis is not
     * permitted and carrying velocity along that motion does not make sense.
     * </p>
     *
     * @param velocityX Horizontal fling velocity in pixels per second
     * @param velocityY Vertical fling velocity in pixels per second
    ...
    protected float getVerticalScrollFactor() {
        if (mVerticalScrollFactor == 0) {
            ...
            if (!mContext.getTheme().resolveAttribute(com.android.internal.R.attr.listPreferredItemHeight, outValue,
                    true)) {
     ...
     *
     *                      Resolution will be done if the value is set to
     *                      TEXT_DIRECTION_INHERIT. The resolution proceeds up the
     *                      parent chain of the view to get the value. If there is
     *                      no parent, then it will return the default
     *                      {@link #TEXT_DIRECTION_FIRST_STRONG}.
     *
     * @attr ref android.R.styleable#View_textDirection
     */
    ...
    /**
     * Reset resolved text direction. Text direction will be resolved during a call
     * to {@link #onMeasure(int, int)}.
     *
     * @hide
     */
     ...
     *         {@link #TEXT_ALIGNMENT_CENTER}, {@link #TEXT_ALIGNMENT_TEXT_START},
     *         {@link #TEXT_ALIGNMENT_TEXT_END}, {@link #TEXT_ALIGNMENT_VIEW_START},
     ...
     *
     *                      Resolution will be done if the value is set to
     *                      TEXT_ALIGNMENT_INHERIT. The resolution proceeds up the
     *                      parent chain of the view to get the value. If there is
     *                      no parent, then it will return the default
     *                      {@link #TEXT_ALIGNMENT_GRAVITY}.
     *
     ...
     *         {@link #TEXT_ALIGNMENT_TEXT_START}, {@link #TEXT_ALIGNMENT_TEXT_END},
     *         {@link #TEXT_ALIGNMENT_VIEW_START}, {@link #TEXT_ALIGNMENT_VIEW_END}
     *
     * @attr ref android.R.styleable#View_textAlignment
     */
    @ViewDebug.ExportedProperty(category = "text", mapping = {
    ...
    /**
     * Reset resolved text alignment. Text alignment will be resolved during a call
     * to {@link #onMeasure(int, int)}.
     *
     * @hide
     */
    ...
    /**
     * Generate a value suitable for use in {@link #setId(int)}. This value will not
    ...
    /**
     * Gets the Views in the hierarchy affected by entering and exiting Activity
     * Scene transitions.
     * 
     * @param transitioningViews This View will be added to transitioningViews if it
     *                           is VISIBLE and a normal View or a ViewGroup with
     *                           {@link android.view.ViewGroup#isTransitionGroup()}
     *                           true.
     * @hide
     */
    ...
    /**
     * Adds all Views that have {@link #getTransitionName()} non-null to
     * namedElements.
     * 
     * @param namedElements Will contain all Views in the hierarchy having a
     *                      transitionName.
     * @hide
     */
    ...
    /**
     * Returns the pointer icon for the motion event, or null if it doesn't specify
     * the icon. The default implementation does not care the location or event
     * types, but some subclasses may use it (such as WebViews).
     * 
     * @param event        The MotionEvent from a mouse
     * @param pointerIndex The index of the pointer for which to retrieve the
     *                     {@link PointerIcon}. This will be between 0 and
     *                     {@link MotionEvent#getPointerCount()}.
     * @see PointerIcon
     */
    ...
    /**
     * Set the pointer icon for the current view. Passing {@code null} will restore
     * the pointer icon to its default value.
     * 
     * @param pointerIcon A PointerIcon instance which will be shown when the mouse
     *                    hovers.
     */
     ...
     * by the {@link View#setTranslationX(float)} and {@link View#getTranslationX()}
     * methods.
     */
     ...
     * by the {@link View#setTranslationY(float)} and {@link View#getTranslationY()}
     * methods.
     */
     ...
     * by the {@link View#setTranslationZ(float)} and {@link View#getTranslationZ()}
     * methods.
     */
    ...
    /**
     * A Property wrapper around the <code>rotation</code> functionality handled by
     * the {@link View#setRotation(float)} and {@link View#getRotation()} methods.
     */
    ...
    /**
     * A Property wrapper around the <code>rotationX</code> functionality handled by
     * the {@link View#setRotationX(float)} and {@link View#getRotationX()} methods.
     */
    ...
    /**
     * A Property wrapper around the <code>rotationY</code> functionality handled by
     * the {@link View#setRotationY(float)} and {@link View#getRotationY()} methods.
     */
    ...
    /**
     * A Property wrapper around the <code>scaleX</code> functionality handled by
     * the {@link View#setScaleX(float)} and {@link View#getScaleX()} methods.
     */
    ...
    /**
     * A Property wrapper around the <code>scaleY</code> functionality handled by
     * the {@link View#setScaleY(float)} and {@link View#getScaleY()} methods.
     */
     ...
     * height. A MeasureSpec is comprised of a size and a mode. There are three
     * possible modes:
     * <dl>
     * <dt>UNSPECIFIED</dt>
     ...
     *
     * <dt>EXACTLY</dt>
     * <dd>The parent has determined an exact size for the child. The child is going
    ...
    public static class MeasureSpec {
         ...
         * implementation was such that the order of arguments did not matter and
         * overflow in either value could impact the resulting MeasureSpec.
         * {@link android.widget.RelativeLayout} was affected by this bug. Apps
         * targeting API levels greater than 17 will get the fixed, more strict
         * behavior.
         * </p>
         *
        ...
        /**
         * Like {@link #makeMeasureSpec(int, int)}, but any spec with a mode of
         * UNSPECIFIED will automatically get a size of 0. Older apps expect this.
         *
        ...
        static int adjust(int measureSpec, int delta) {
            ...
            size += delta;
            if (size < 0) {
                Log.e(VIEW_LOG_TAG, "MeasureSpec.adjust: new size would be negative! (" + size + ") spec: "
    ...
    /**
     * Sets the name of the View to be used to identify Views in Transitions. Names
     * should be unique in the View hierarchy.
     *
     * @param transitionName The name of the View to uniquely identify it for
     *                       Transitions.
     */
     ...
     * </p>
     *
     * @return The name used of the View to be used to identify Views in Transitions
    ...
    /**
     * Interface definition for a callback to be invoked when a hardware key event
     * is dispatched to this view. The callback will be invoked before the key event
     * is given to the view. This is only useful for hardware keyboards; a software
     * input method has no obligation to trigger this listener.
     */
    public interface OnKeyListener {
         ...
         * although some may elect to do so in some situations. Do not assume a software
         * input method has to be key-based; even if it is, it may use key presses in a
         * different way than you expect, so there is no way to reliably catch soft
         * input key presses.
         *
         * @param v       The view the key has been dispatched to.
         * @param keyCode The code for the physical key that was pressed
         * @param event   The KeyEvent object containing full information about the
         *                event.
     ...
     * dispatched to this view. The callback will be invoked before the touch event
     ...
     * dispatched to this view. The callback will be invoked before the hover event
     * is given to the view.
     */
    ...
    public interface OnDragListener {
        /**
         * Called when a drag event is dispatched to a view. This allows listeners to
         * get a chance to override base View behavior.
         *
    ...
    /**
     * Interface definition for a callback to be invoked when a view is context
     * clicked.
     */
    ...
    public interface OnCreateContextMenuListener {
         ...
         * @param menuInfo Extra information about the item for which the context menu
    ...
    public interface OnSystemUiVisibilityChangeListener {
         ...
         *                   <strong>global</strong> state of these UI visibility flags,
         *                   not what your app is currently applying.
         */
     ...
     *
     * <p>
     * Apps may choose to implement this interface if they want to apply custom
     * policy to the way that window insets are treated for a view. If an
     * OnApplyWindowInsetsListener is set, its
     * {@link OnApplyWindowInsetsListener#onApplyWindowInsets(View, WindowInsets)
     * onApplyWindowInsets} method will be called instead of the View's own
     * {@link #onApplyWindowInsets(WindowInsets) onApplyWindowInsets} method. The
     * listener may optionally call the parameter View's
     * <code>onApplyWindowInsets</code> method to apply the View's normal behavior
     * as part of its own.
     * </p>
     */
    public interface OnApplyWindowInsetsListener {
        /**
         * When
         * {@link View#setOnApplyWindowInsetsListener(View.OnApplyWindowInsetsListener)
         * set} on a View, this listener method will be called instead of the view's own
    ...
    /**
     * Base class for derived classes that want to save and restore their own state
    ...
    public static class BaseSavedState extends AbsSavedState {
        ...
        /**
         * Constructor used when reading from a parcel using a given class loader. Reads
    ...
    final static class AttachInfo {
        ...
        /**
         * InvalidateInfo is used to post invalidate(int, int, int, int) messages to a
         * Handler. This class contains the target (View) to invalidate and the
         * coordinates of the dirty rectangle.
         *
         * For performance purposes, this class also implements a pool of up to
         * POOL_LIMIT objects that get reused. This reduces memory allocations whenever
         * possible.
         */
        static class InvalidateInfo {
            private static final int POOL_LIMIT = 10;

            private static final SynchronizedPool<InvalidateInfo> sPool = new SynchronizedPool<InvalidateInfo>(
                    POOL_LIMIT);
        ...
        /**
         * The state of the display to which the window is attached, as reported by
         * {@link Display#getState()}. Note that the display state constants declared by
         * {@link Display} do not exactly line up with the screen state constants
         * declared by {@link View} (there are more display states than screen states).
         */
        ...
        /**
         * For windows that are full-screen but using insets to layout inside of the
         * screen areas, these are the current insets to appear inside the overscan area
         * of the display.
         */
        ...
        /**
         * For windows that are full-screen but using insets to layout inside of the
         * screen decorations, these are the current insets for the content of the
         * window.
         */
        ...
        /**
         * For windows that are full-screen but using insets to layout inside of the
         * screen decorations, these are the current insets for the actual visible parts
         * of the window.
         */
        ...
        /**
         * For windows that are full-screen but using insets to layout inside of the
         * screen decorations, these are the current insets for the stable system
         * windows.
         */
        final Rect mStableInsets = new Rect();

        /**
         * For windows that include areas that are not covered by real surface these are
         * the outsets for real surface.
         */
        final Rect mOutsets = new Rect();

        /**
         * In multi-window we force show the navigation bar. Because we don't want that
         * the surface size changes in this mode, we instead have a flag whether the
         * navigation bar size should always be consumed, so the app is treated like
         * there is no virtual navigation bar at all.
         */
        boolean mAlwaysConsumeNavBar;

        /**
         * The internal insets given by this window. This value is supplied by the
         * client (through {@link ViewTreeObserver.OnComputeInternalInsetsListener}) and
         * will be given to the window manager when changed to be used in laying out
         * windows behind it.
         */
        ...
        /**
         * All views in the window's hierarchy that serve as scroll containers, used to
         * determine if the window can be resized or must be panned to adjust for a soft
         * input area.
         */
        ...
        /**
         * This flag tracks when the mIgnoreDirtyState flag is set during draw(), to
         * avoid clearing that flag prematurely.
         */
        ...
        /**
         * Indicates whether the view has requested unbuffered input dispatching for the
         * current event stream.
         */
        boolean mUnbufferedDispatchRequested;

        /**
         * Indicates that ViewAncestor should trigger a global layout change the next
         * time it performs a traversal
         */
        ...
        /**
         * Set if the window has requested to extend into the overscan region via
        ...
        /**
         * Global to the view hierarchy used as a temporary for dealing with x/y points
         * in the transparent region computations.
         */
        final int[] mTransparentLocation = new int[2];

        /**
         * Global to the view hierarchy used as a temporary for dealing with x/y points
         * in the ViewGroup.invalidateChild implementation.
         */
        final int[] mInvalidateChildLocation = new int[2];

        /**
         * Global to the view hierarchy used as a temporary for dealing with computing
         * absolute on-screen location.
         */
        ...
        /**
         * The view tree observer used to dispatch global events like layout, pre-draw,
         * touch mode change, etc.
         */
        ...
        /**
         * Temporary for use in computing invalidate rectangles while calling up the
         * hierarchy.
         */
        ...
        /**
         * Used to track views that need (at least) a partial relayout at their current
         * size during the next traversal.
         */
        ...
        /**
         * Creates a new set of attachment information with the specified events handler
         * and thread.
         *
         * @param handler the events handler the view must use
         */
        AttachInfo(IWindowSession session, IWindow window, Display display, ViewRootImpl viewRootImpl, Handler handler,
     ...
     * supported. This avoids keeping too many unused fields in most instances of
     * View.
     * </p>
     */
    private static class ScrollabilityCache implements Runnable {
        ...
        /**
         * When fading should start. This time moves into the future every time a new
         * scroll happens. Measured based on SystemClock.uptimeMillis()
         */
    ...
    /**
     * Resuable callback for sending {@link AccessibilityEvent#TYPE_VIEW_SCROLLED}
     * accessibility event.
     */
    ...
    /**
     * <p>
     * This class represents a delegate that can be registered in a {@link View} to
     * enhance accessibility support via composition rather via inheritance. It is
     * specifically targeted to widget developers that extend basic View classes
     * i.e. classes in package android.view, that would like their applications to
     * be backwards compatible.
     * </p>
     * <div class="special reference">
     * <h3>Developer Guides</h3>
     * <p>
     * For more information about making applications accessible, read the <a href="
     ...
     * {@link View#onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo)} is not
     * available in API version 4 when the accessibility APIs were first introduced.
     * If a developer would like his application to run on API version 4 devices
     * (assuming all other APIs used by the application are version 4 or lower) and
     * take advantage of this method, instead of overriding the method which would
     * break the application's backwards compatibility, he can override the
     * corresponding method in this delegate and register the delegate in the target
     * View if the API version of the system is high enough i.e. the API version is
     * same or higher to the API version that introduced
     ...
     * method in View for the case of no accessibility delegate been set. Hence, to
     * customize the behavior of a View method, clients can override only the
    ...
    public static class AccessibilityDelegate {
         ...
         * {@link #sendAccessibilityEvent(View, int)} but takes as an argument an empty
         * {@link AccessibilityEvent} and does not perform a check whether accessibility
         * is enabled.
         * <p>
         * The default implementation behaves as
         * {@link View#sendAccessibilityEventUnchecked(AccessibilityEvent)
         * View#sendAccessibilityEventUnchecked(AccessibilityEvent)} for the case of no
         * accessibility delegate been set.
         * </p>
         *
         * @param host  The View hosting the delegate.
        ...
        /**
         * Dispatches an {@link AccessibilityEvent} to the host {@link View} first and
         * then to its children for adding their text content to the event.
         * <p>
         * The default implementation behaves as
         * {@link View#dispatchPopulateAccessibilityEvent(AccessibilityEvent)
         * View#dispatchPopulateAccessibilityEvent(AccessibilityEvent)} for the case of
         ...
         * View#onPopulateAccessibilityEvent(AccessibilityEvent)} for the case of no
         * accessibility delegate been set.
         * </p>
         *
         * @param host  The View hosting the delegate.
        ...
        /**
         * Initializes an {@link AccessibilityEvent} with information about the the host
         * View which is the event source.
         * <p>
         * The default implementation behaves as
         * {@link View#onInitializeAccessibilityEvent(AccessibilityEvent)
         * View#onInitializeAccessibilityEvent(AccessibilityEvent)} for the case of no
         * accessibility delegate been set.
         * </p>
         *
         * @param host  The View hosting the delegate.
        ...
        /**
         * Initializes an {@link AccessibilityNodeInfo} with information about the host
         * view.
         * <p>
         * The default implementation behaves as
         * {@link View#onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo)
         * View#onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo)} for the case
         ...
         * ViewGroup#onRequestSendAccessibilityEvent(View, AccessibilityEvent)} for the
         ...
         * instance by calling {@link AccessibilityNodeInfo#recycle()} to minimize
         * object creation.
         * </p>
         * <p>
         * The default implementation behaves as
         * {@link View#createAccessibilityNodeInfo() View#createAccessibilityNodeInfo()}
    ...
    /**
     * Determine if this view is rendered on a round wearable device and is the main
     * view on the screen.
     */
