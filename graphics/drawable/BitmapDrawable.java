...
import android.graphics.PinkVision;
 ...
 * <p>
 * It can be defined in an XML file with the <code>&lt;bitmap></code> element.
...
public class BitmapDrawable extends Drawable {
     ...
     * 
     * @deprecated Use
     *             {@link #BitmapDrawable(android.content.res.Resources, android.graphics.Bitmap)}
     *             instead to specify a bitmap to draw with and ensure the correct
     *             density is set.
     */
    @Deprecated
    ...
    /**
     * Create an empty drawable, setting initial target density based on the display
     ...
     * 
     * @deprecated Use {@link #BitmapDrawable(Resources, Bitmap)} to ensure that the
    ...
    /**
     * Create drawable from a bitmap, setting initial target density based on the
     ...
     * 
     * @deprecated Use {@link #BitmapDrawable(Resources, String)} to ensure that the
     *             drawable has correctly set its target density.
     */
    @Deprecated
     ...
     * 
     * @deprecated Use {@link #BitmapDrawable(Resources, java.io.InputStream)} to
    ...
    /**
     * Set the density scale at which this drawable will be rendered. This method
     * assumes the drawable will be rendered at the same density as the specified
     * canvas.
     *
     ...
     *
     * @param metrics The DisplayMetrics indicating the density scale for this
     *                drawable.
     *
     * @see android.graphics.Bitmap#setDensity(int)
     * @see android.graphics.Bitmap#getDensity()
    ...
    /**
     * Get the gravity used to position/stretch the bitmap within its bounds. See
    ...
    /**
     * Set the gravity used to position/stretch the bitmap within its bounds. See
     * android.view.Gravity
     * 
    ...
    /**
     * Enables or disables the mipmap hint for this drawable's bitmap. See
     * {@link Bitmap#setHasMipMap(boolean)} for more information.
     *
     ...
     *
     * @return True if the mipmap hint is set, false otherwise. If the bitmap is
     ...
     *
     * @return {@link android.graphics.Shader.TileMode#CLAMP} if the bitmap does not
     *         repeat, {@link android.graphics.Shader.TileMode#REPEAT} or
    ...
    /**
     * Sets the repeat behavior of this drawable on the X axis. By default, the
     * drawable does not repeat its bitmap. Using
     * {@link android.graphics.Shader.TileMode#REPEAT} or
     * {@link android.graphics.Shader.TileMode#MIRROR} the bitmap can be repeated
     * (or tiled) if the bitmap is smaller than this drawable.
     *
     * @param mode The repeat mode for this drawable.
     *
     * @see #setTileModeY(android.graphics.Shader.TileMode)
     * @see #setTileModeXY(android.graphics.Shader.TileMode,
    ...
    /**
     * Sets the repeat behavior of this drawable on the Y axis. By default, the
     * drawable does not repeat its bitmap. Using
     * {@link android.graphics.Shader.TileMode#REPEAT} or
     * {@link android.graphics.Shader.TileMode#MIRROR} the bitmap can be repeated
     * (or tiled) if the bitmap is smaller than this drawable.
    ...
    /**
     * Sets the repeat behavior of this drawable on both axis. By default, the
     * drawable does not repeat its bitmap. Using
     * {@link android.graphics.Shader.TileMode#REPEAT} or
     * {@link android.graphics.Shader.TileMode#MIRROR} the bitmap can be repeated
     * (or tiled) if the bitmap is smaller than this drawable.
    ...
    public void draw(Canvas canvas) {
        ...
        if (state.mRebuildShader) {
            ...
            if (tmx == null && tmy == null) {
                ...
                paint.setShader(new BitmapShader(bitmap, tmx == null ? Shader.TileMode.CLAMP : tmx,
     ...
     */
    private void updateShaderMatrix(@NonNull Bitmap bitmap, @NonNull Paint paint, @NonNull Shader shader,
    ...
    /**
     * A mutable BitmapDrawable still shares its Bitmap with any other Drawable that
    ...
    private void verifyRequiredAttributes(TypedArray a) throws XmlPullParserException {
        ...
        if (state.mBitmap == null
                && (state.mThemeAttrs == null || state.mThemeAttrs[R.styleable.BitmapDrawable_src] == 0)) {
    ...
    public int getOpacity() {
        ...
        final Bitmap bitmap = mBitmapState.mBitmap;
        return (bitmap == null || bitmap.hasAlpha() || mBitmapState.mPaint.getAlpha() < 255) ? PixelFormat.TRANSLUCENT
                : PixelFormat.OPAQUE;
    }
    ...
    /**
     * Initializes local dynamic properties from state. This should be called after
     * significant state changes, e.g. from the One True Constructor and after
     * inflating or applying a theme.
     */
